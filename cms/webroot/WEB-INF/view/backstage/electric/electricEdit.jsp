...
<html>
	<head>
		<meta charset="UTF-8">
		<title>电桩编辑</title>
		<link rel="stylesheet" type="text/css" href="${ctx}/static/css/electric/electricEdit.css"/>
	</head>
	<body>
		<div id="container1">
			<div class="nav">
...
<script src="${ctx}/static/js/electric/electricEdit.js" type="text/javascript" charset="utf-8"></script>
</html>