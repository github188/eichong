...
<html>
	...
	<body>
		<div class="container-statistics">
			...
			<section class="main">
				<!--充电金额（实时）&充电次数 （两条折线图）-->
				<div class="mainTab">
					<span class="active">充电（实时）</span>
				</div>
				<div class="mainTabContent">
					<div class="mainTabBlock" style="width:1000px;height: 350px;margin: 0 auto;" id="realtimeData">
					...
					<div class="detaiData">
						...
						<table class="myTable" style="margin-top:0 ;">
							<thead>
								<tr class="active">
									<th>时间</th>
									<th style="padding-left: 12px;">充电金额</th>
									<th>充电次数</th>
									<th>充值金额</th>
									<th>充值次数</th>
								</tr>
							</thead>
							<tbody id="realTimeTbody">
	...
	<script src="${ctx}/static/js/consumeStatistics/realTimeDate.js" type="text/javascript" charset="utf-8"></script>
</html>
