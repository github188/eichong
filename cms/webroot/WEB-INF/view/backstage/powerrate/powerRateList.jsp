...
<html>
	<head>
		<meta charset="UTF-8">
		<title>电费管理</title>
		<link rel="stylesheet" type="text/css" href="${ctx}/static/css/config/powerRateList.css"/>
	</head>
	<body>
		<div id="container1">
			<div class="box">
...
<script src="${ctx}/static/js/config/powerRateList.js" type="text/javascript" charset="utf-8"></script>
</html>