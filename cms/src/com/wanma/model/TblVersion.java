 ...
 *
 */
public class TblVersion extends Entity {
	...
	private int isAutoUpdate;//是否强制更新
	...
	public String toString() {
		return "TblVersion [pkVersion=" + pkVersion + ", versNumber="
				+ versNumber + ", versType=" + versType + ", versUrl="
				+ versUrl + ", versRemark=" + versRemark + ", versCreatedate="
				+ versCreatedate + ", versUpdatedate=" + versUpdatedate
