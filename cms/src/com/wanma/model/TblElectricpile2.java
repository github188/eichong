 ...
 * 
 */
public class TblElectricpile2 extends Entity {
	...
	private java.lang.String elpiTell;// 联系电话
	...
	private int elPiRelevancePowerStation;	//所属充电点
	...
	private Integer relevancePowerStation;//所属充电点
	...
	private Integer elPiHaveConnectLine; // 是否有枪(电桩是否有连接线 1有，0没有 默认0)
	...
	private java.lang.Integer elPiOwnerCompany;//运营平台
	...
	private String companyNumber; //公司标识（商户名称）
	...
	public Integer getRelevancePowerStation() {
		return relevancePowerStation;
	}

	public void setRelevancePowerStation(Integer relevancePowerStation) {
	...
	public java.lang.String getElpiTell() {
		return elpiTell;
	}

	public void setElpiTell(java.lang.String elpiTell) {
	...
	public String getElpiParkingFee() {
		return elpiParkingFee;
	}

	public void setElpiParkingFee(String elpiParkingFee) {
		this.elpiParkingFee = elpiParkingFee;
	}
