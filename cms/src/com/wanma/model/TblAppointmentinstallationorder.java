 ...
 * 
 */
public class TblAppointmentinstallationorder extends Entity {
	/**
	 * 
	 */
	...
	public String toString() {
		return "TblAppointmentinstallationorder [pkAppointmentinstallationorder="
				...
				+ ", userPhone="
				+ userPhone
				+ ", factNames=" + factNames + ", factName=" + factName + "]";
	}
