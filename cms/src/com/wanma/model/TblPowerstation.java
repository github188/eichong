 ...
 * 
 */
public class TblPowerstation extends Entity {
	private static final long serialVersionUID = -212970025435807457L;
	...
	private java.lang.String postEleids; // 充电点绑定相关电桩，电桩id用逗号隔开
	...
	private String poStCreateUserId;// 所属用户
	// 页面搜索用，不以数据库对应
	...
	private List<TblElectricpile> electricList;// 电桩列表
	...
	public String toString() {
		...
		sb.append(", poStCreateUser=").append(poStCreateUserId);
