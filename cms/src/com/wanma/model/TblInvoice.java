 ...
 * 
 */
public class TblInvoice extends Entity{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8080314299776030419L;
	private int pkInvoice;//主键
	private String userId;//用户id
	private String ivPayFreight;//支付类型：0-账户余额支付， 1-微信支付，2-支付宝支付，3-货到付款
	private String createDates;//创建日期
	private String updateDates;//修改日期
	private String ivPhoneNumber;//电话
	private String ivNumber;//发票号码
	private String ivState;//发票申请状态：0-已申请， 1-已开票
	private String ivType;//开票类型：0-个人开票 ，1-公司开票
	private String ivCompanyName;//公司抬头	
	private String ivInvoiceAmount;//开票金额
	private String ivTaxpayerNumber;//纳税人识别号
	private String ivCompanyAddress;//公司地址	
	private String ivBankName;//开户行	
	private String ivBankAccount;//银行字段
	...
	public String getIvInvoiceAmount() {
		return ivInvoiceAmount;
	}

	public void setIvInvoiceAmount(String ivInvoiceAmount) {
	...
	public String getIvPayFreight() {
		return ivPayFreight;
	}

	public void setIvPayFreight(String ivPayFreight) {
