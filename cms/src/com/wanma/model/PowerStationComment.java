 ...
 * 
 */
public class PowerStationComment extends Entity {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8530134350066229713L;
	private java.lang.Integer pk_PsComment; //
	private java.lang.Integer psc_PsId; // 充电点id
	private java.lang.Integer psc_UserId; // 用户Id(tbl_user_normal_view表中获取)
