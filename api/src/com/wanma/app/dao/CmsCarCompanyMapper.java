...
import com.wanma.model.TblCarCompnay;
...
public interface CmsCarCompanyMapper {
    ...
    /**
     * 根据carinfoID查找对应的汽车厂家(现在是车牌名，建议改成车牌ID)
     * @param params
     * @return
     */
    
    public TblCarCompnay getEntityByCarinfoName(String carinfoName);
    /**
    ...
    public TblCarCompnay getEntityByCarinfoId(Integer carinfoId);
