 ...
 * @version：V1.0
 */
public interface AppBespokeMapper {
	public final static String PREFIX = AppBespokeMapper.class.getName();
	 ...
	 * @return
	 */
	public int getBespIdByBespCodeAndUid(TblBespoke bespoke);
