 ...
 *
 */
public class TblGateservice implements Serializable {
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1497141157417508879L;
    ...
    public String toString() {
        ...
        sb.append("TblGateservice");
        sb.append("{pkGateid=").append(pkGateid);
        sb.append(", gtseGatename=").append(gtseGatename);
        sb.append(", gtseGateip=").append(gtseGateip);
        sb.append(", gtseGateport=").append(gtseGateport);
        sb.append(", gtseCreatetime=").append(gtseCreatetime);
        sb.append(", gtseUpdatetime=").append(gtseUpdatetime);
		sb.append('}');
        return sb.toString();
    }
}