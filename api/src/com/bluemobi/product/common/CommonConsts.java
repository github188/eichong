...
public interface CommonConsts {
	...
	/** 超级用户区分 */
	public static String SUPPER_USER_LEVEL_ID = "0";
	...
	/** 用户检查状态：用户冻结*/
	public static String USER_STATUS_CHECK_FREEZE = "004";
	/** 用户检查状态区分：登录正确 */
	public static String USER_STATUS_CHECK_OK = "100";
	/** 用户检查状态区分：不存在用户 */
	public static String USER_STATUS_CHECK_NO_USER = "1011";
	/** 用户检查状态区分：密码错误 */
	public static String USER_STATUS_CHECK_ERROR_PASSWORD = "1012";
	/**用户检查状态：用户账号或密码为空*/
	public static String USER_STATUS_CHECK_NO_USER_ACCOUND = "1013";
	/**用户检查状态 : 非政企版用户*/
	public static String USER_STATUS_CHECK_ERROR_USER="1014";
	/**用户退出处理结果 : 退出失败 */
	public static String USER_STATUS_CHECK_ERROR="1015";
	/**验证码校验结果 : 验证码错误*/
	public static String CHECK_RESULT_ERROR="1016";
	/**验证码校验结果 : 超时*/
	public static String CHECK_RESULT_ERROR_NG="1017";
	/**验证码校验结果 : 无效验证码*/
	public static String CHECK_RESULT_ON_ERROR="1018";
	/**验证码校验结果 : 验证码为空*/
	public static String CHECK_RESULT_NO="1019";
	/**手机号校验结果 : 验证码发送时间间隔过短,请稍后发送*/
	public static String CHECK_RESULT_INTERVAL="1020";
	/**手机号校验结果 : 验证码发送次数已达上限*/
	public static String CHECK_RESULT_DEGREE="1021";
	/**手机号校验结果 : 手机号为空*/
	public static String CHECK_RESULT_NO_PHONE="1022";
	/**手机号校验结果 : 手机号格式错误*/
	public static String CHECK_RESULT_PHONE_INVALID="1023";
	/**手机号校验结果 : 手机号没有绑定手机号*/
	public static String CHECK_RESULT_PHONE_NO="1024";
	...
	/** 用户分类:系统用户 */
	public static String USER_LEVEL_SYSTEM = "1";
	/** 用户分类:商家用户 */
	public static String USER_LEVEL_POS = "2";
	/** 用户分类:APP注册用户 */
	public static String USER_LEVEL_APP = "3";
	/** 用户分类:物业用户 */
	public static String USER_LEVEL_ESTATE = "4";
	...
	/** 验证码有效时间 */
	public static Long AUTHCODE_EFFECTIVE_TIME = 600l;
	/** 系统设置文件:图片服务器上传地址*/
	...
	public static String RENEW_CACHE_TIMER = "renew.cache.timer";
}
