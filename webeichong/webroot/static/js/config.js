 ...
 * @type {string}
 */
config.pageServer = location.protocol + '//' + location.host + config.projectName + '/'; //页面服务器地址
...
config.urlSuffix = '.do';
config.appInterfaceServer=location.protocol + '//' + location.host;
...
//注册
config.PReg = createRootPageUrl('regist');
//登录
...
//新增用户安装地址
config.PAddInstallAddress = createModelPageUrl(config.MEnergyModel,'addInstallAdrs');
//选择已购商品
config.POrderProduct = createModelPageUrl(config.MEnergyModel,'orderProduct');
//预约安装成功
config.PInstallSuccess = createModelPageUrl(config.MEnergyModel,'installSuccess');
//立即购买
config.PPromptlyBuy = createModelPageUrl(config.MEnergyModel,'confirmOrder');
//
config.PTradeSuccess = createModelPageUrl(config.MEnergyModel,'tradeSuccess');
...
//电站详情
config.IGetElectricPlant = createWebInterfaceUrl('powerstation/detail');
//电桩详情
config.IGetElectricPile = createWebInterfaceUrl('electricpile/detail');
//评价列表
...
//收藏
config.ICollect = createWebInterfaceUrl('usercollect/userFavorites');
//获取评论
config.ICommentList = createWebInterfaceUrl('productComment/findProComments');
//加入购物车
config.IInsertIntoCart = createWebInterfaceUrl('shoppingcart/insertIntoCartNew');
//删除购车中商品
config.IDeleteCart = createWebInterfaceUrl('shoppingcart/deleteCartNew');
//我的购物车列表
config.IFindMyCart = createWebInterfaceUrl('shoppingcart/findMyCartNew');
//购物车页面，结算新增订单
config.IOrder = createWebInterfaceUrl('myOrder/insertShopOrderInfo');
//获取默认收货地址
config.IAddress = createWebInterfaceUrl('userAddress/findDefaultNew'); 
//获取订单中商品信息
...
//获取所有收货地址
config.IAddresses = createWebInterfaceUrl('userAddress/findAddressesNew');
//删除地址
config.IDeleteAddress = createWebInterfaceUrl('userAddress/deleteAddressNew');
//根据主键获取地址
config.IFindAddress = createWebInterfaceUrl('userAddress/getAddressNew');
//设置地址为默认地址
config.IUpdateIsDefault = createWebInterfaceUrl('userAddress/updateIsDefaultNew');
//新增用户地址
config.IAddAddress = createWebInterfaceUrl('userAddress/insertAddressNew');
//编辑用户地址
config.IEditAddress = createWebInterfaceUrl('userAddress/updateAddressNew');
//用户安装地址
config.IFindInstallAddresses = createWebInterfaceUrl('installAddress/findAddresses');
//删除安装地址
config.IDeleteInstallAddress = createWebInterfaceUrl('installAddress/deleteAddress');
//新增安装地址
config.IInsertInstallAddress = createWebInterfaceUrl('installAddress/insertAddress');
//根据主键获取安装地址
config.IGetInstallAddress = createWebInterfaceUrl('installAddress/getAddress');
//更新安装地址
config.IUpdateInstallAddress = createWebInterfaceUrl('installAddress/updateAddress');
//获取已购买还未设置安装地址的商品
config.ISelectNoAddProduct = createWebInterfaceUrl('installAddress/selectNoAddProduct');
//新增已购商品安装地址信息
config.IInsertOrderAddress = createWebInterfaceUrl('OrderAddress/insertOrderAddress');
//删除已购商品安装地址信息
config.IDeleteOrderAddress = createWebInterfaceUrl('OrderAddress/deleteOrderAddress');
//删除已购商品安装地址信息
config.IInsertAppointmentNew = createWebInterfaceUrl('appointment/insertAppointmentNew');
//更新订单状态
config.IUpdateOrderstatus = createWebInterfaceUrl('myOrder/updateOrderstatus');

//服务与支持--意见反馈  /*http://localhost:8080/webeichong/web/other/addTblFeedBack.do*/
