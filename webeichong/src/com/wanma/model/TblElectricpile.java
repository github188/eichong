...
public class TblElectricpile extends BasicListAndMutiFile  implements Serializable {
	...
	private java.math.BigDecimal elpiLatitude; // 电桩地址维度
	...
	private java.lang.Integer elpiPoweruser; // 电桩用途，配置参数内容的ID（3电动车，4电动自行车，多功能（电动车、电动自行车、手机USB））
	private java.lang.Integer elpiChargingmode; // 电桩充电方式，配置参数内容的ID
												// （5直流充电桩，14交流充电桩）
	private java.lang.Integer elpiPowersize; // 电桩额定功率，配置参数内容的ID（6:3.5kw，15:7kw，16:20kw，17:50kw，18:75kw）
	...
	private java.lang.Integer elpiBinding; // 电桩是否绑定电站（0-未绑定 1-已绑定）
	...
	private java.lang.Integer commStatus;//连接状态
	private int relevancePowerStation;//所属电站
	...
	public java.lang.Integer getCommStatus() {
		return commStatus;
	}

	public void setCommStatus(java.lang.Integer commStatus) {
	...
	public String toString() {
		...
		sb.append("{pkElectricpile=").append(pkElectricpile);
		sb.append(", elpiElectricpilename=").append(elpiElectricpilename);
		sb.append(", elpiElectricpilecode=").append(elpiElectricpilecode);
		sb.append(", elpiElectricpileaddress=").append(elpiElectricpileaddress);
		sb.append(", elpiLongitude=").append(elpiLongitude);
		sb.append(", elpiLatitude=").append(elpiLatitude);
		sb.append(", elpiPowernumber=").append(elpiPowernumber);
		sb.append(", elpiAreacode=").append(elpiAreacode);
		sb.append(", elpiState=").append(elpiState);
		sb.append(", elpiRejectionreason=").append(elpiRejectionreason);
		sb.append(", elpiType=").append(elpiType);
		sb.append(", elpiPoweruser=").append(elpiPoweruser);
		sb.append(", elpiChargingmode=").append(elpiChargingmode);
		sb.append(", elpiPowersize=").append(elpiPowersize);
		sb.append(", elpiPowerinterface=").append(elpiPowerinterface);
		sb.append(", elpiMaker=").append(elpiMaker);
		sb.append(", elpiImage=").append(elpiImage);
		sb.append(", elpiDetailimage=").append(elpiDetailimage);
		sb.append(", elpiOutputvoltage=").append(elpiOutputvoltage);
		sb.append(", elpiInputvoltage=").append(elpiInputvoltage);
		sb.append(", elpiOutputcurrent=").append(elpiOutputcurrent);
		sb.append(", elpiInputcurrent=").append(elpiInputcurrent);
		sb.append(", elpiUsertype=").append(elpiUsertype);
		sb.append(", elpiUserid=").append(elpiUserid);
		sb.append(", elpiCreatedate=").append(elpiCreatedate);
		sb.append(", elpiUpdatedate=").append(elpiUpdatedate);
		sb.append(", elpiRemark=").append(elpiRemark);
		sb.append(", elpiCarid=").append(elpiCarid);
		sb.append(", elpiBinding=").append(elpiBinding);
		sb.append(", elpiIsappoint=").append(elpiIsappoint);
		sb.append(", elpiPaystyle=").append(elpiPaystyle);
		sb.append(", elpiMaxelectricity=").append(elpiMaxelectricity);
