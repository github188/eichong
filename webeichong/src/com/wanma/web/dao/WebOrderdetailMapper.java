 ...
 * 
 */
public interface WebOrderdetailMapper {
	public final static String PREFIX = WebOrderdetailMapper.class.getName();
	 ...
	 * @return
	 */
	public List<TblOrderdetail> selectProductsByOrderId(java.lang.Integer orDeParentId);
