...
import com.wanma.web.dao.WebInstalladdressMapper;
 ...
 */
@Service
public class WebInstalladdressServiceImpl implements WebInstalladdressService {
	/* 用户安装地址表操作dao */
	@Autowired
	private WebInstalladdressMapper installaddressMapper;
	/* 已购商品安装地址关联表操作dao */
	@Autowired
