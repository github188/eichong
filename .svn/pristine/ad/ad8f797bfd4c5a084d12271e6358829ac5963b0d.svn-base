...
public class TblPartner  extends Entity{
	...
	public String toString() {
		return "TblPartner [partnerId=" + partnerId + ", partnerName="
				+ partnerName + ", partnerKey=" + partnerKey
				+ ", partnerToken=" + partnerToken + ", registerdate="
				+ registerdate + ", partnerClientId=" + partnerClientId
				+ ", partnerUpdateCycleType=" + partnerUpdateCycleType
				+ ", partnerUpdateCycleValue=" + partnerUpdateCycleValue
				+ ", partnerClientIp=" + partnerClientIp
				+ ", partnerClientPort=" + partnerClientPort
				+ ", partnerClientKey=" + partnerClientKey + ", createdate="
				+ createdate + ", updatedate=" + updatedate + ", paymod="
				+ paymod + "]";
	}
