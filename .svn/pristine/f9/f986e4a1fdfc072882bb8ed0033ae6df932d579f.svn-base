...
public class TblChargingOrder extends BasicListAndMutiFile{
	...
	private String chorParterExtradata;//第三方流水号
	private Integer psId;
	private String startChargeSeq;//中电联第三方订单编号
	private Double totalPower;//累计电量
	private Double tatalMoney;//累计金额
	...
	public String getChOrOrgNo() {
		return chOrOrgNo;
	}
	public void setChOrOrgNo(String chOrOrgNo) {
		this.chOrOrgNo = chOrOrgNo;
	}
	public String getChorParterExtradata() {
		return chorParterExtradata;
	}
	public void setChorParterExtradata(String chorParterExtradata) {
		this.chorParterExtradata = chorParterExtradata;
	}
	...
	public String toString() {
		return "TblChargingOrder [pkChargingorder=" + pkChargingorder
				...
				+ ", chOr_valleyPower=" + chOr_valleyPower + ", chOrOrgNo="
				+ chOrOrgNo + ", beginChargetime=" + beginChargetime
				+ ", endChargetime=" + endChargetime + ", chOrUserOrigin="
				+ chOrUserOrigin + ", pkUserCard=" + pkUserCard
				+ ", couponMoney=" + couponMoney + ", couponCondition="
				+ couponCondition + ", limitation=" + limitation + ", eleCode="
				+ eleCode + ", userPhone=" + userPhone + ", usName=" + usName
				+ ", goName=" + goName + ", eleheadName=" + eleheadName
				+ ", usPhone=" + usPhone + ", comName=" + comName
				+ ", chorUser=" + chorUser + ", loginUserId=" + loginUserId
				+ ", userLevel=" + userLevel + ", chargePointName="
				+ chargePointName + ", chargePointAddress="
				+ chargePointAddress + ", puhiInvoiceStatus="
				+ puhiInvoiceStatus + ", ownerShip=" + ownerShip
				+ ", elPiRateInformationId=" + elPiRateInformationId
				+ ", chReQuantumDate=" + chReQuantumDate + ", chReJPrice="
				+ chReJPrice + ", chReFPrice=" + chReFPrice + ", chRePPrice="
				+ chRePPrice + ", chReGPrice=" + chReGPrice
				+ ", chReServiceCharge=" + chReServiceCharge
				+ ", chorParterUserLogo=" + chorParterUserLogo
				+ ", chorParterExtradata=" + chorParterExtradata + ", psId="
				+ psId + ", startChargeSeq=" + startChargeSeq + ", totalPower="
				+ totalPower + ", tatalMoney=" + tatalMoney + "]";
	}
