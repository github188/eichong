...
<form action="http://192.168.1.249:8001/interaction-service-2.0.0/playTimes" method="get">
 ...
 -->
<form action="<%=basePath%>/simple/chargeStop.do" method="get">
...
<tr>
<td>userPhone<font color="red">*</font></td>
<td><input id="userPhone" name="userPhone" type="text" value="tjd0102" /></td>
</tr>
<tr>
...
<td><input id="orderId" name="orderId" type="text" value="201707290091121" /></td>
</tr>
<tr>
