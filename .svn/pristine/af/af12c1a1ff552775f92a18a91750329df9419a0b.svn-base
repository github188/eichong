...
public class TblElectricpileServiceImpl implements TblElectricpileService {
	...
	@Override
	public List<TblElectricpile> getElectricPileByPowerStationId(
			TblElectricpile tblElectricpile) {
		return electricpileMapper.getElectricPileByPowerStationId(tblElectricpile);
	}

	@Override
	public List<TcbElectric> getElectricList(Map<String, Object> model) {
		return electricpileMapper.getElectricList(model);
	}

	@Override
	public int checkPowerStation(Map<String, Object> mapl) {
		return electricpileMapper.checkPowerStation(mapl);
	}

	@Override
	public List<Map<String, Object>> getHeadMeterNum(Map<String, Object> hmap) {
		return electricpileMapper.getHeadMeterNum(hmap);
	}
