 ...
 * 
 */
public class TblOrder extends BasicListAndMutiFile implements Serializable {
	/**
	 * 
	 */
	...
	private java.lang.Integer ordeStatus; // 1：待支付 2 支付成功 3 操作完成 4 待发货 5已发货
	...
	private String ordeCommodityShops;//所属商铺
	private java.lang.Integer ordeCommodityTotal;//订单商品总数
	...
	public String getOrdeCommodityShops() {
		return ordeCommodityShops;
	}

	public void setOrdeCommodityShops(String ordeCommodityShops) {
		this.ordeCommodityShops = ordeCommodityShops;
	}
