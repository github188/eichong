...
//	}
	...
	public String setPayPwd(HttpServletRequest request){
		...
		return HttpUtil.doPost(WanmaConstants.setPayCipher, params);
	}
	...
	public String checkPayPwd(HttpServletRequest request){
		...
		return HttpUtil.doPost(WanmaConstants.checkPayCipher, params);
	}
	...
	public String modPayPwd(HttpServletRequest request){
		...
		return HttpUtil.doPost(WanmaConstants.modPayCipher, params);
	}
	...
	public String modPassword(HttpServletRequest request){
		...
		return HttpUtil.doPost(WanmaConstants.modCipher, params);
	}
...
//		}
	...
	public String resetPasswrod(HttpServletRequest request){
		...
		// 调用API并将结果返回
		return HttpUtil.doPost(WanmaConstants.resetCipher, params);	
