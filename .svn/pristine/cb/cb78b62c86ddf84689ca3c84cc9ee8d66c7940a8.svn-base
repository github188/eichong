 ...
 * 2015-05-27	
 */
public class TblPilemaker extends Entity {
	...
	private java.lang.String bindCount; // 绑定电桩的数量
	...
	public java.lang.String getBindCount() {
		return bindCount;
	}

	public void setBindCount(java.lang.String bindCount) {
