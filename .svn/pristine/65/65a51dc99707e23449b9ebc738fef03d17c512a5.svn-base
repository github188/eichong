...
function deleteFile(imageUrl,obj,referenceId){
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#buttonFileId_edit").val("");
		$("#buttonFileId_edit").val($("#buttonFileId_edit").val()+dataId);
		var url=obj.navTabId;
		$("#editbtImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#editbtImage t").length;
	    if(fileSize>=1){ 
