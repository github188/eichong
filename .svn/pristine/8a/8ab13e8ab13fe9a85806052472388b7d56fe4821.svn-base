...
public class TblElectricpile extends BasicListAndMutiFile  implements Serializable {
	...
	private java.lang.String  elPiOwnProvinceCode;//所属城市code
	private java.lang.String  elPiOwnCityCode;//所属地区区县code
