 ...
 * @version：V1.0
 */
public interface WebUseraddressMapper {
	public final static String PREFIX = WebUseraddressMapper.class.getName();
	 ...
	 * @return 
	 */
	public <T> T findDefault(java.lang.Integer pkUserInfo);
	 ...
	 */
	public List<TblUseraddress> find(TblUseraddress tblUseraddress);
