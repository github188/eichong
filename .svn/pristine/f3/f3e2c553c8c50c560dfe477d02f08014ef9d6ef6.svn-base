 ...
 * 电桩查找(列表模式)
 */
public class ElectricPileListDO {
    ...
    private String electricChargingMode;//电桩充电方式
    ...
    private String electricLatitude;//纬度
    ...
    public String getElectricChargingMode() {
        return electricChargingMode;
    }

    public void setElectricChargingMode(String electricChargingMode) {
        this.electricChargingMode = electricChargingMode;
    }
