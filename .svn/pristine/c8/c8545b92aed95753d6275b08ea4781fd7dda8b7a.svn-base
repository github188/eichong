...
@Service
public class CmsWanmaBespokeIncomeExcelServiceImpl extends CmsExcelServiceImpl {
	@Autowired
	private CmsExcelReportMapper excelReportMapper;
	private String[] columns = { "纯商家名称", "月份","总预约成功次数","总预约时间(分钟)","总收益金额(元)" };//初始化列名
	...
	protected void makeExcelData(HSSFWorkbook wb, Object paramsModel) {
		...
		List<Map<String, Object>> list = excelReportMapper
				.queryWanmaBespokeIncomeList((ExcelParamModel)paramsModel);
