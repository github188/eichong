...
function deleteFile(imageUrl,obj,referenceId){
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#newsInfoFileId_add").val("");
		$("#newsInfoFileId_add").val($("#newsInfoFileId_add").val()+dataId);
		var url=obj.navTabId;
	
		$("#addniImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#addniImage t").length;
	    if(fileSize>=1){ 
