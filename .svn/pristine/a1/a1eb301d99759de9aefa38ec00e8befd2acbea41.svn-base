...
public class BomListDO extends BasicModel {

	/**
	 * BOM清单表
	 */
	private static final long serialVersionUID = -2569890626230860501L;
	...
	private java.lang.Integer blHardwareType;//硬件类型
	...
	public java.lang.Integer getBlHardwareType() {
		return blHardwareType;
	}
	public void setBlHardwareType(java.lang.Integer blHardwareType) {
		this.blHardwareType = blHardwareType;
	}
