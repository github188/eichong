...
public interface CommonConsts {
	...
	/** 接口配置文件 */
	public static String PRO_FILE_INTERFACE_SETTING = "interface.properties";
	...
	/** 数据库连接设置文件:密码 */
	public static String PRO_KEY_DB_CIPHER = "jdbc.password";
	/** 数据库连接设置文件:URL */
	...
	/** 数据库连接设置文件:密码 */
	public static String dbCipher = "jdbcPassword";

	/** 系统设置文件:用户默认密码 */
	public static String MAP_KEY_DEFAULT_USER_CIPHER = "defaultPassword";
	/** MAP KEY:用户默认密码 */
	public static String PRO_KEY_DEFAULT_USER_CIPHER = "user.default.password";
	...
	/** 用户检查状态区分：不存在用户 */
	public static String USER_STATUS_CHECK_ERROR_CIPHER = "003";
	...
	public static String DEFAULT_CIPHER_STRING = "123456";
