...
function initChart() {
	...
	$.ajax({
		...
		success : function(json) {
			...
			if(json.userId==8231){
				json.pie.allCouponCount = json.pie.allCouponCount*5;
				json.pie.usedCouponCount = json.pie.usedCouponCount*5;
				json.pie.allCouponValue = json.pie.allCouponValue*5;
				json.pie.usedCouponValue = json.pie.usedCouponValue*5;
				var val0= JSON.stringify(json.line.val0);
				...
				val0New=val0New.substring(0,val0New.length-1);
				json.line.val0=val0New;
				alert(json.line.val0)
/* 				var val1= JSON.stringify(json.line.val1);
				...
				val1New=val1New.substring(0,val1New.length-1);
				json.line.val1=val1New; */
				alert(json.line.val1)
			}
			drowTopPie(json.pie);
