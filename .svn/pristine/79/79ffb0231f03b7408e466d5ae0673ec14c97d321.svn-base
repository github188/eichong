...
<form id="form" method="post" action="rateinfo/addRateInfo.do" class="pageForm required-validate" 
	...
	<div class="pageFormContent nowrap" layoutH="97">	
		...
		<dl>
			...
			<input name="raIn_TipTimeTariff" id="raIn_Tip_Electricity"  class="textInput required" maxlength="5" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="峰段电价 / 度"/></dt><dd>
			<input name="raIn_PeakElectricityPrice" id="raIn_Peak_Electricity"   class="textInput required" maxlength="5" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="平段电价 / 度"/></dt><dd>
			<input name="raIn_UsualPrice" id="raIn_Flat_Electricity"   class="textInput required" maxlength="5" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="谷段电价 / 度"/></dt><dd>
			<input name="raIn_ValleyTimePrice" id="raIn_Valley_Electricity"   class="textInput required " maxlength="5" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		...
		<dl>
			...
			<input name="raIn_ServiceCharge" id="raIn_ServiceCharge"   class="textInput required number"  maxlength="5" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
