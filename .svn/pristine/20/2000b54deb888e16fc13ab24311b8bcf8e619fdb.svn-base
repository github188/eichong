 ...
 * banner管理
 */
public class TblAppButton extends BasicListAndMutiFile implements
		Serializable {
		...
		public String toString() {
			return "TblAppButton [pkButtonId=" + pkButtonId + ", buttonDesc="
					+ buttonDesc + ", buttonName=" + buttonName
					+ ", buttonUrl=" + buttonUrl + ", buttonStatus="
					+ buttonStatus + ", buttonSort=" + buttonSort
					+ ", buttonType=" + buttonType + ", buttonAction="
					+ buttonAction + ", buttonCreatedate=" + buttonCreatedate
					+ ", buttonUpdatedate=" + buttonUpdatedate
