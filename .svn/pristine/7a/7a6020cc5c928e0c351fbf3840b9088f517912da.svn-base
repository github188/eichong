...
public class TblUser extends BasicListAndMutiFile {
	...
	private String applyCard;// 充电卡申请状态
	...
	private String busiCompanyNumber;// 公司标示
	private String category;// 角色分类(普通管理员 2,纯商家3,商家子角色4,个体商家5,接入商 6, 入驻商7)
	...
	private Integer ucPayMode;// 卡类型(查询可绑定用户列表专用)
	private Integer isBigAccount = 0;// 是否大账户
	private String isQuicklyApply;// 是否大账户
	...
	public Integer getIsBigAccount() {
		return isBigAccount;
	}

	public void setIsBigAccount(Integer isBigAccount) {
		this.isBigAccount = isBigAccount;
	}

	public String getIsQuicklyApply() {
		return isQuicklyApply;
	}

	public void setIsQuicklyApply(String isQuicklyApply) {
		this.isQuicklyApply = isQuicklyApply;
	}

	public String getBusiCompanyNumber() {
		return busiCompanyNumber;
	}

	public void setBusiCompanyNumber(String busiCompanyNumber) {
		this.busiCompanyNumber = busiCompanyNumber;
	}
	...
	public String toString() {
		return "TblUser [userId=" + userId + ", userAccount=" + userAccount
				...
				+ busiParentId + ", busiName=" + busiName + ", busiPhone="
				+ busiPhone + ", adminName=" + adminName + ", adminPhone="
				+ adminPhone + ", applyCard=" + applyCard + ", idCardPic="
				+ Arrays.toString(idCardPic) + ", createTime=" + createTime
				+ ", endTime=" + endTime + ", userImage=" + userImage
				+ ", idCardimage=" + idCardimage + ", rePassword=" + rePassword
				+ ", normCarCompany=" + normCarCompany + ", normCarType="
				+ normCarType + ", busiCompany=" + busiCompany
				+ ", busiCompanyNumber=" + busiCompanyNumber + ", category="
				+ category + ", pileCount=" + pileCount + ", childCount="
				+ childCount + ", roleNames=" + roleNames + ", cardId="
				+ cardId + ", phone=" + phone + ", ucPayMode=" + ucPayMode
				+ ", isBigAccount=" + isBigAccount + ", isQuicklyApply="
				+ isQuicklyApply + "]";
	}
