...
public class WanmaConstants {
   ...
   public static String MULTI_TYPE_ELECTRICT_LIST_SUBGRAPH = "electricListSubgraph";// 电桩列表子图片
	...
	public static String ADV_PIC = "advPic";// 广告屏图
	public static String ADV_LIST_PIC = "advListPic";// 广告动态列表图
...
/*	static {
		...
		if(provinceCache==null){
			ProvinceService provinceService=(ProvinceService)ApplicationContextUtils.getBean("provinceService");
			List<Province> provinceCodeList=provinceService.getProvinceList();
	...
	/**支付宝-电站信息推送缓存目录*/
	public static String ALIPAY_ORDER_TIME = "third:alipay:ordertime";
	//上海停车办项目
	public static String PRI_OPERATOR_ID = "MA27W7H33";
	//public static String PRI_OPERATOR_SECRET = "1234567890abcdef";
    //public static final String AUTH_TOKEN = "Bearer ";//Token的固定偏移值
    //public static final String DATA_SECRET_IV = "1234567890abcdef";//初始化向量
