...
public class TblPureBusiness extends Entity{
...
//	private String parentLoveLoginId;   //商加主账号登录ID，主账号为空，子账号为主商家登录ID
	private String puBuParentLoveLoginId;//商加主账号登录ID，主账号为空，子账号为主商家登录ID 
	...
	public String getPuBuParentLoveLoginId() {
		return puBuParentLoveLoginId;
	}
	public void setPuBuParentLoveLoginId(String puBuParentLoveLoginId) {
		this.puBuParentLoveLoginId = puBuParentLoveLoginId;
	}
