...
public class Favorites {
	...
	private String favoriteType;//收藏   收藏类型 1-商城收藏  2-电桩 3-充电点
	...
	private int elPi_PowerUser;//电动车、自行车
	
	
	public int getElPi_PowerUser() {
		return elPi_PowerUser;
	}
	public void setElPi_PowerUser(int elPi_PowerUser) {
		this.elPi_PowerUser = elPi_PowerUser;
	}
