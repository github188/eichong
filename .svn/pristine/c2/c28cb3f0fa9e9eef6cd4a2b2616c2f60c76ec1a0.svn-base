...
<%@ page import="com.wanma.tenpay.*" %>
<%@ page import="com.wanma.model.*" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
<%@ page import="org.apache.commons.logging.*" %>
<%@ page import="com.wanma.web.service.impl.WebUserinfoServiceImpl" %>
...
if(map!=null&&map.size()>0){
	...
	if("SUCCESS".equals(return_code)&&"SUCCESS".equals(result_code)){
		//处理数据库逻辑
		Boolean flag=userinfoService.addReChargeRecordForTenpay(map,request);
