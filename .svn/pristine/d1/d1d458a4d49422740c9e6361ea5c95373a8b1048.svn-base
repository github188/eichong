...
public class HMacMD5 {
	...
	public static void main(String[] args) {
		...
		String org = "01294771X";
		//String data = "RP/Z26h/ejO0ORlAz93dNcfowTJ44Bt3IK7dAUIHWs8=";
		String data="8HXtjmuna/oB1UYmapz+2yU6ajMn63S36yfds21rM0Y=";
		String timeStamp = "20171109100618";
		String seq = "0034";
		String sigStr = org + data + timeStamp + seq;
		System.out.println(getHmacMd5Str("1234567890abcda3", sigStr));
		
		
		// System.out.println(getHmacMd5Str("1234567890abcdef",
		// "OperatorID=425010765&Data="LastQueryTime":1,"PageNo":1,"PageSize":10&TimeStamp=20170420145007&Seq=0001));
