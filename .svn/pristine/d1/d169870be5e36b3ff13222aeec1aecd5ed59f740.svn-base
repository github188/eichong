...
public class CmsFinanceServiceImpl implements CmsFinanceService {
	...
	public List<Map<String, Object>> getCustomerBillManageList(Map<String, Object> params) {
		return cmsFinanceMapper.getCustomerBillManageList(params);
	}

	@Override
	public long getCustomerBillManageListCount(Map<String, Object> params) {
		return cmsFinanceMapper.getCustomerBillManageListCount(params);
	}

	@Override
	public List<Map<String, Object>> getinvoiceRecordList(Map<String, Object> params) {
		return cmsFinanceMapper.getinvoiceRecordList(params);
	}
	

	@Override
	public List<Map<String, Object>> getBillOrderList(Map<String, Object> params) {
		return cmsFinanceMapper.getBillOrderList(params);
	}

	@Override
	public TblInvoice getInvoiceRecordById(int pkInvoice) {
		return cmsFinanceMapper.getInvoiceRecordById(pkInvoice);
	}

	@Override
	public void changeInvoiceRecord(Map<String, Object> params) {
		cmsFinanceMapper.changeInvoiceRecord(params);
	}


	@Override
	public long getinvoiceRecordListCount(Map<String, Object> params) {
		return cmsFinanceMapper.getinvoiceRecordListCount(params);
	}

	@Override
	public int insertInvoiceRecord(TblInvoice tblInvoice) {
		return cmsFinanceMapper.insertInvoiceRecord(tblInvoice);
	}

	@Override
	public void removeInvoiceRecord(TblInvoice tblInvoice) {
		cmsFinanceMapper.removeInvoiceRecord(tblInvoice);
	}

	@Override
	public void getModifyBillingStatus(Map<String, Object> params) {
		cmsFinanceMapper.getModifyBillingStatus(params);
	}

	@Override
	public List<Map<String, Object>> getInvoicedOrderList(Map<String, Object> params) {
		return cmsFinanceMapper.getInvoicedOrderList(params);
	}
