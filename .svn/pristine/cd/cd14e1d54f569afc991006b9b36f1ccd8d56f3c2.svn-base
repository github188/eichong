...
public class TblApplyPartner extends BasicListAndMutiFile implements Serializable{
			...
			public String toString() {
				return "TblApplyPartner [pkApplyPartner=" + pkApplyPartner
						+ ", apPaServiceQQ=" + apPaServiceQQ
						+ ", apPaUserName=" + apPaUserName + ", apPaUserPhone="
						+ apPaUserPhone + ", apPaCreatedate=" + apPaCreatedate
						+ ", apPaUpdatedate=" + apPaUpdatedate
						+ ", apPaDealReason=" + apPaDealReason
						+ ", apPaProcessState=" + apPaProcessState
						+ ", apPaPointName=" + apPaPointName
						+ ", apPaStationAddr=" + apPaStationAddr
						+ ", apPaStationType=" + apPaStationType
						+ ", apPaInstallation=" + apPaInstallation
						+ ", apPaPileNum=" + apPaPileNum + ", apPaOpenTime="
						+ apPaOpenTime + ", apPaChargingCost="
						+ apPaChargingCost + ", apPaCarTypeMatch="
						+ apPaCarTypeMatch + ", apPaUserEmail=" + apPaUserEmail
						+ ", apPaCooperationMode=" + apPaCooperationMode
						+ ", apPaPartnerType=" + apPaPartnerType
						+ ", apPaStationTypeText=" + apPaStationTypeText
						+ ", apPaAcPileNum=" + apPaAcPileNum
						+ ", apPaDcPileNum=" + apPaDcPileNum
						+ ", apPaOpenTimeWorkDay=" + apPaOpenTimeWorkDay
						+ ", apPaOpenTimeHoliday=" + apPaOpenTimeHoliday
						+ ", apPaChargingFee=" + apPaChargingFee
						+ ", apPaServiceFee=" + apPaServiceFee
						+ ", apPaParkingFee=" + apPaParkingFee
						+ ", apPaCompanyName=" + apPaCompanyName
						+ ", createDateStarte=" + createDateStarte
						+ ", createDateEnd=" + createDateEnd
						+ ", updateDateStart=" + updateDateStart
						+ ", updateDateEnd=" + updateDateEnd
						+ ", apPaProvinceAddress=" + apPaProvinceAddress
						+ ", apPaCityAddress=" + apPaCityAddress
