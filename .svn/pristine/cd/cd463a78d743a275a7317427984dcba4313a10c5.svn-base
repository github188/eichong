 ...
 * 
 */
public class TblProductcomment extends Entity{
	/**
	 * 
	 */
	...
	private java.lang.Integer prcoUserid; // 用户Id(tbl_user_normal_view表中获取)
	...
	private java.lang.Integer prcoCommentType; // 1：桩体评价 2：充电点评价 3：商城商品评价:
	...
	/**
	 * 获取用户Id(tbl_user_normal_view表中获取)属性
	 * 
	 * @return prcoUserid
	 */
	...
	/**
	 * 设置用户Id(tbl_user_normal_view表中获取)属性
	 * 
	 * @param prcoUserid
	 */
