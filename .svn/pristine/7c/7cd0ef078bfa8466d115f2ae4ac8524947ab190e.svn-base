 ...
 *
 */
public class TblPurchasehistory extends Entity {
	private static final long serialVersionUID = 2754171242699607434L;
	...
	private int puHiUserOrigin;// 用户来源 1:富士康; 2:吉利; 3:绿地; 4:浙誉; 5:车纷享;
								// 以后根据情况再扩展或修改

	private String puHiElectricPileCode;// 桩体编号
	private int puHiExternalCardNumber;// 卡主键

	private String puHiTransactionNumber;// 充电交易流水号
	private String puHiPaymentNumber;// 充值订单编号

	private String puHiBespokeNumber;// 预约编号
	...
	public int getPuHiExternalCardNumber() {
		return puHiExternalCardNumber;
	}

	public void setPuHiExternalCardNumber(int puHiExternalCardNumber) {
		this.puHiExternalCardNumber = puHiExternalCardNumber;
	}

	public int getPuHiUserOrigin() {
		return puHiUserOrigin;
	}

	public void setPuHiUserOrigin(int puHiUserOrigin) {
	 ...
	 */
	public void setPuhiPurchasehistorytime(
			java.util.Date puhiPurchasehistorytime) {
	...
	public String toString() {
		return "TblPurchasehistory [pkPurchasehistory=" + pkPurchasehistory
				+ ", puhiType=" + puhiType + ", puhiPurchasehistorytime="
				+ puhiPurchasehistorytime + ", puhiMonetary=" + puhiMonetary
				+ ", puhiConsumerremark=" + puhiConsumerremark
				+ ", puhiCreatedate=" + puhiCreatedate + ", puhiUpdatedate="
				+ puhiUpdatedate + ", puhiPurchasecontent="
				+ puhiPurchasecontent + ", puhiUserid=" + puhiUserid
				+ ", puhiChargeType=" + puhiChargeType + ", starttime="
				+ starttime + ", endtime=" + endtime + ", userPhone="
				+ userPhone + ", userName=" + userName + ", groupName="
				+ groupName + "]";
	}
