		...
		<div id="mainList" class="mainListStyle">
			...
			<div
				...
				<input id="" type="checkbox" name="headState" value="3"
					otherCheckBox="pileStatus" onclick="remakeCheckBox(this)" />预约 <input
					id="" type="checkbox" name="headState" value="6"
					otherCheckBox="pileStatus" onclick="remakeCheckBox(this)" />充电 <input
					id="" type="checkbox" name="headState" value="0"
					otherCheckBox="pileStatus" onclick="remakeCheckBox(this)" />空闲<br>
				<input
				...
				<input id="" type="checkbox" name="headState" value="9"
					otherCheckBox="pileStatus" onclick="remakeCheckBox(this)" />故障 <input
