...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>集中器新增</title>
		<link rel="stylesheet" type="text/css" href="${ctx}/static/css/concentrator/concentratorAdd.css" />
	</head>
	...
	<script src="${ctx}/static/js/concentrator/concentratorAdd.js" type="text/javascript" charset="utf-8"></script>
