...
public class TblElectricpilehead implements Serializable {
	private static final long serialVersionUID = -1588838999264356092L;
	...
	private String electricPileCode;//电桩编码
	private String electricpileHeadId;//枪头Id
	private String cpyId;//公司标识
	...
	public String getElectricpileHeadId() {
		return electricpileHeadId;
	}

	public void setElectricpileHeadId(String electricpileHeadId) {
	...
	public String toString() {
		return "TblElectricpilehead [pkElectricpilehead=" + pkElectricpilehead
				...
				+ ", raInQuantumDate=" + raInQuantumDate + ", psId=" + psId
				+ ", psIds=" + Arrays.toString(psIds) + ", electricPileCode="
				+ electricPileCode + ", electricpileHeadId="
				+ electricpileHeadId + ", cpyId=" + cpyId + "]";
	}
