...
<div class="Mean_Box">
  ...
  <div class="Denlu_Main">
    ...
    <ul>
      ...
      <li><span class="yonghuming"><input name="username" value="${username}" type="text" id="userName" minlength="6" maxlength="16" onblur="testUserName()"/></span></li>
      <li>
      	<span class="mima">
      ...
      <li>
      	...
      	<span class="yanzhengma"><img id="codeImg" src="" onclick="reloadCode()" style="cursor: pointer;"  width="80" height="38" /></span>
      	<span class="huanyizhang">
      		<a href="#" onclick="reloadCode()">换一张</a>
      	</span>
      	
      </li>
      <li class="regTest" id="regTest" style="height:20px; line-height:20px;text-align:left;color:#ffff66; font-size:12px;">${erMessage}</li><!--提示这行Li在没有错误提示的时候不显示-->
      <li><span class="tijiao"><input name="登录" type="submit" value="登录" id="loginUser" /></span></li>
