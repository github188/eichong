...
import com.wanma.web.dao.WebUsershareelecMapper;
 ...
 */
@Service
public class WebUsercollectServiceImpl implements WebUsershareelecService {

	@Autowired
	WebUsershareelecMapper tblUsershareelecMapper;
