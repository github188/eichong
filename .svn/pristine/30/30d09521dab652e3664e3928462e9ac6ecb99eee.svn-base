...
<form action="http://192.168.1.249:8001/interaction-service-2.0.0/playTimes" method="get">
 ...
 -->
<form action="<%=basePath%>/eichong/getStubId.do" method="post">
...
<tr>
<td>gunQrCode<font color="red">*</font></td>
<td><input id="gunQrCode" name="gunQrCode" type="text" value="819859" /></td>
</tr>
