 ...
 * 
 */
public class TblProductcomment extends BasicListAndMutiFile {
	/**
	 * 
	 */
	...
	private java.lang.Integer prcoCommentType; // 1：桩体评价 2：商城商品评价 3：充值评价
	...
	public String toString() {
		...
		sb.append("TblProductcomment");
		sb.append("{pkProductcomment=").append(pkProductcomment);
		sb.append(", prcoProductid=").append(prcoProductid);
		sb.append(", prcoUserid=").append(prcoUserid);
		sb.append(", prcoUsername=").append(prcoUsername);
		sb.append(", prcoCreatetime=").append(prcoCreatetime);
		sb.append(", prcoCommentstart=").append(prcoCommentstart);
		sb.append(", prcoCommentpic=").append(prcoCommentpic);
		sb.append(", prcoOrderid=").append(prcoOrderid);
		sb.append(", prcoCommentType=").append(prcoCommentType);
		sb.append(", prcoCreatedate=").append(prcoCreatedate);
		sb.append(", prcoUpdatedate=").append(prcoUpdatedate);
		sb.append(", prcoUtatus=").append(prcoUtatus);
		sb.append(", prcoContent=").append(prcoContent);
		sb.append('}');
		return sb.toString();
	}
}