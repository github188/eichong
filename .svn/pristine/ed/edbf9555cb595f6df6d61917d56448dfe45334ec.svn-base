...
<div id="ploat" style="width:300px;height:180px;left:550px;top:200px;z-index:9999;position:absolute;background:#e6edef;padding:40px;padding-right:60px;display: none">
	<div class="one" >
		...
		<div class="radio">
			<input type="radio" checked="checked" value="1" name='status'>开
			<input type="radio" style="margin-left:40px" value="0" name='status'>关
		</div>
	</div><br>
	<div class="one">
		...
		<tbody>
			<c:forEach items="${timeChargeList}" var="electric" varStatus="status">
				<tr target="id" rel="${electric.pkElectricpile}" align="center">
					<td><input name="ids" value="" type="checkbox" class="checkbox" id="${electric.elpiElectricpilecode}" data-value="${electric.elpiElectricpilecode}"></td>
...
var elpiElectricpilecodes="";
	$("#startUp").click(function(){
			$(".checkbox").each(function(){
				...
				if ($("#"+elpiElectricpilecode).attr('checked')) {
