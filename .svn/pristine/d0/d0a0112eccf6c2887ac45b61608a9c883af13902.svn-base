...
<script type="text/javascript" src="<%=basePath%>/static/js/electric/electric-plant.js"></script>
<script type="text/html" id="detail-data-tmpl">
		<div class="electri-inf">
			<div class="left-con">
				<img src="<!--[=$absImg(powerStationImage)]-->" id="data_pic"></div>
			<div class="left-con mt30 ml30">
				<h3 id="data_title"><!--[=powerStationName]--></h3>

				<p class="same num">
					<span>桩体总数：</span>
					<span class="ml10"><!--[=powerElectricpileSum]--></span>
					个
				</p>

				<p class="same static">
					<span>充电点状态：</span>
					<span class="ml10"><!--[=$mateArray(powerStationState, 9)]--></span>
				</p>

				<p class="same address" id="data_address">
					<span><!--[=powerStationAddress]--></span>
				</p>

				<p class="same tel" id="data_tel">
					<span>人工服务：</span>
					<span class="ml10"><!--[=powerStationTell]--></span>
				</p>

				<div class="clearfix mt40 cs-wrap">
					<div class="collect fl active" id="collect_submit" data-id="<!--[=powerStationId]-->">收藏</div>
					<div class="share fl">
		...
		<div class="electric-main">
			<div class="left-main">
				...
				<div class="map-wrap" id="plantMap">
				</div>
		...
		<div class="electric-num toggle none">
			<h4 class="mt40 mb30 tit">站内桩体状态</h4>
			<ul class="electric-con">
			<!--[for(i = 0;i < powerElectricpileList.length;i++){]-->
				<li>
					<a href="javascript:void(0);" id="pile_detail" data-id="<!--[=powerElectricpileList[i].elictricPicId]-->">
						<img src="<!--[=$absImg(powerElectricpileList[i].elictricPicImage)]-->"/>
					</a>
					<h4><!--[=powerElectricpileList[i].elictricPicName]--></h4>
					<!--[for(j = 0;j < powerElectricpileList[i].pileHeadList.length;j++){]-->
					<p class="mt5">
						<span>
							<!--[=powerElectricpileList[i].pileHeadList[j].pileHeadName]-->
							<span class="ml20 <!--[=$attrDecide(powerElectricpileList[i].pileHeadList[j].pileHeadState, '0', 'fc-orange')]-->">
								<!--[=$mateArray(powerElectricpileList[i].pileHeadList[j].pileHeadState, 1)]--></span>
						</span>
					</p>
					<!--[}]-->
				</li>
		...
		<div class="clearfix">
			...
			<div class="clearfix"><a class="submit-btn tm fr mt10" href="javascript:void(0);" id="evaluate_submit" data-name="${webUser.userRealName}">提交</a></div>
		<h4 class="mb30 tit">用户评价<span>（<!--[=powerCommentSum]-->）</span>
			<div class="star-wrap">
				<a class="fl f18 more" href="javascript:void(0);" id="evaluate_detail">点击更多 >></a>
			</div>
		</h4>
		<ul class="ping-con">
