...
public class ApiUtil {
	...
	public static String getToken() throws Exception {
		...
		String apiTokenPath = GlobalSystem.getConfig("apiTokenPath");
		String token = HttpsUtil.getResponseParam(apiRoot + apiTokenPath,
				"data");
	...
	public static String sendRequest(Map<String, String> params)
		...
		if ("100".equals(obj.getString("status"))) {
			result = new BaseSuccess(obj.getString("msg"));
		} else {
			result = new BaseFail(obj.getString("msg"));
		}
