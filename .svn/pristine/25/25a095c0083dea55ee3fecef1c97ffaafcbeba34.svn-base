...
<div class="pageContent">
	<form method="post" action="rateinfo/updateRateInfo.do" id="meditForm"
		...
		<dd><label><input type="radio" id="radio1" name="raInType"  value="1"/>两位</label>
		    <label><input type="radio" id="radio2" name="raInType"  value="2" />四位</label></dd>
		</dl>
		<dl>
		
			<dt><bmtag:message messageKey="尖段电价 / 度"/></dt><dd>
			<input name="raIn_TipTimeTariff" id="raInChange_Tip_Electricity" value="${rateMap.raIn_TipTimeTariff}"   class="textInput required"  maxlength="6" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="峰段电价 / 度"/></dt><dd>
			<input name="raIn_PeakElectricityPrice" id="raInChange_Peak_Electricity" value="${rateMap.raIn_PeakElectricityPrice}"  class="textInput required" maxlength="6" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="平段电价 / 度"/></dt><dd>
			<input name="raIn_UsualPrice" id="raInChange_Flat_Electricity" value="${rateMap.raIn_UsualPrice}"  class="textInput required" maxlength="6" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
			<dt><bmtag:message messageKey="谷段电价 / 度"/></dt><dd>
			<input name="raIn_ValleyTimePrice" id="raInChange_Valley_Electricity" value="${rateMap.raIn_ValleyTimePrice}"   class="textInput required" maxlength="6" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		...
		<dl>
			...
			value="${rateMap.raIn_ServiceCharge}" maxlength="6" style="width:130px;"/>
			<span class="info"></span>
			</dd>
		</dl>
		<dl>
...
<script>		
	...
	$(document).ready(function(){ 
	    ...
	    var raintype=${rateMap.raIn_type};
		if(raintype==1){
