/**
 * FileName:AppApiDepartmentModel.java
 ...
 * @date 2014年6月26日
 *//*
public class AppApiDepartmentModel extends BasicModel {

	*//**
	 * serial version ID
	 *//*
	private static final long serialVersionUID = -6046808976862703164L;
