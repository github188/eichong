...
<div class="pageContent">
	<form method="post" action="electric/changeElectricPile.do"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<input type="hidden" name="elpiElectricpilecode" value="${tblElectricpile.elpiElectricpilecode}"/>
			<%-- <dl>
				<dt>
			...
			<dl>
				...
				<dd>
					<input name="elpiLongitude" maxlength="20"
						class="textInput required" style="width: 165px;" max="136" min="74"
						value="${tblElectricpile.elpiLongitude}" /> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				<dt>
			...
			<dl>
				...
				<dd>
					<select name="elpiChargingmode" id="elpiChargingmode" class="select_Style" onchange="changePileNum(this.value)">
			...
			<dl>
				...
				<dd>
				<input type="hidden" id="elpiState" name="elpiState" value="${tblElectricpile.elpiState}" />
			...
			<dl>
				...
				<dd>
					<select name="elpiMaker" id="elpiMaker" class="select_Style required">
			...
			<dl>
				...
				<dd>
					<select name="elpiTypeSpanId" id="elpiTypeSpanId" class="select_Style required">
			...
			<c:if test="${loginUserLevel != 5}">
				<dl>
					...
					<dd>
						<input name="companyNumber" type="hidden" value="${tblElectricpile.companyNumber}" id="companyNumber"/>
						<input name="companyName" type="text" value="${tblElectricpile.companyName}"
							disabled id="companyName"/>
							<a class="btnLook" 
							href="../admin/electric/getCompanyNumberList.do"
							lookupGroup="">查找公司</a>
							 <span class="info">(请选择公司)</span>
			...
			<dl>
				...
				<dd>
					<input name="ownerShip" id="ownerShip" class="textInput required"
						maxlength="13" style="width: 165px;" value="${tblElectricpile.ownerShip}"/> <span class="info"></span>
				</dd>
			</dl>
			 <dl>
				<dt>
				...
				<dd>
					<select name="elPiOwnProvinceCode" id="elPiOwnProvinceCode" style="width: 172px !important" class="select_Style" onchange="getCity(this)">
						<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd>
					<select id="editCityId" name="elPiOwnCityCode" class="select_Style editCityId" onchange="getCounty(this)" >
						<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd>
					<select id="editCountyId" name="elPiOwnCountyCode" class="select_Style editCountyId" onchange="getRateinfo(this)">
					<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd id="imageDD">
					<c:forEach var="item" items="${tblElectricpile.elpiImageUrl}" varStatus="status" >
							...
							<a href="javascript:void(0);" onclick="deleteFile('${item}',this,'${tblElectricpile.pkElectricpile}')">删除</a>
							</t>
					</c:forEach>
					<input type="hidden" id="businessType" name="businessType" value="electricListImage" />
					<input type="hidden" id="fileId" name="fileId" />
					<input  id="electricEditFileInput"  type="file" name="listImage" class="file" style="width: 260px;" 
					uploaderOption="{
		...
		<dl>
			...
			<dd>
				 <input name="elPiOnlineTime"  value="${tblElectricpile.elPiOnlineTime}" class="textInput" style="width:165px" >
			</dd>
		</dl>
		<dl>
				<dt>
				...
				<dd>
					<select class="required editElPiRateInformationId" id="editElPiRateInformationId" name="elPiRateInformationId" class="select_Style">
						<option value="">-请选择-</option>
						<c:forEach var="item" items="${rateList}">
							<option value="${item.pk_RateInformation}" ${item.pk_RateInformation==
			...
			<dl>
				...
				<dd>
					<input name="elPiSimPhoneNum" class="phone textInput "
						maxlength="13" style="width: 165px;" value="${tblElectricpile.elPiSimPhoneNum}"/> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<input name="elPiSimMac" class="textInput "
						maxlength="20" style="width: 165px;" value="${tblElectricpile.elPiSimMac}" /> <span class="info"></span>
				</dd>
			</dl>
		<%-- <c:if test="${loginUserLevel == '3'}"> --%>
			  <dl>
				...
				<dd>
					<input id="change_offlineTime" class="date" value="${tblElectricpile.offlineTime}" type="text" readonly="true" datefmt="yyyy-MM-dd HH:mm" name="offlineTime" style="width:130px" onClick="WdatePicker({el:'change_offlineTime',dateFmt:'yyyy-MM-dd HH:mm',minDate:'1970-01-01'})">
					<span class="info"></span>
				</dd>
			</dl>
			<%-- </c:if> --%>
			<dl>
				...
				<dd>		 
						...
						<option value="">-请选择-</option>				
							<option value="1" <c:if test="${tblElectricpile.elpiIsappoint == 1}">selected="selected"</c:if>>是</option>
							<option value="0" <c:if test="${tblElectricpile.elpiIsappoint == 0}">selected="selected"</c:if>>否</option>
						</select>
						<span class="info"></span>	
				</dd>
			</dl>
			<dl>
				...
				<dd>		 
						...
						<option value="">-请选择-</option>				
							<option value="1" <c:if test="${tblElectricpile.elPiHaveGps == 1}">selected="selected"</c:if>>是</option>
							<option value="0" <c:if test="${tblElectricpile.elPiHaveGps == 0}">selected="selected"</c:if>>否</option>
						</select>
						<span class="info"></span>	
				</dd>
			</dl>
			<dl>
				...
				<dd>		 
						...
						<option value="">-请选择-</option>				
							<option value="1" <c:if test="${tblElectricpile.elPiHaveLedFlash == 1}">selected="selected"</c:if>>是</option>
							<option value="0" <c:if test="${tblElectricpile.elPiHaveLedFlash == 0}">selected="selected"</c:if>>否</option>
						</select>
						<span class="info"></span>	
				</dd>
			</dl>
	 		<dl>
				...
				<dd>		 
						<select name="elPiHaveConnectLine" class="select_Style required">
							<option value="">-请选择-</option>							
							<option value="1" ${tblElectricpile.elPiHaveConnectLine == 1?'selected':''} >是</option>
							<option value="0" ${tblElectricpile.elPiHaveConnectLine == 0?'selected':''} >否</option>
						</select>
						<span class="info"></span>	
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					...
					<input id="elpiPowernumber" name="elpiPowernumber" maxlength="20" class="textInput required" readonly style="width: 165px;" value="${tblElectricpile.elpiPowernumber}"/>
				</dd>
			</dl>
			<dl>
				<dt>
								...
								<table width="100%">
									...
									<tbody id="row_head">
										<c:forEach var="headInfo" items="${tblElectricpile.headList}" varStatus="status">
											<tr>
												<td><input name="headList[${status.index}].pkElectricpilehead" type="hidden" value="${headInfo.pkElectricpilehead}">
													<input class="required" name="headList[${status.index}].ephNum" type="text" value="${headInfo.ephNum}"></td>
												<td><select style="width: 80px" class="required" name="headList[${status.index}].havaCarPlaceLock">
												...
												<td><select style="width: 80px" class="required" name="headList[${status.index}].haveRadar">
