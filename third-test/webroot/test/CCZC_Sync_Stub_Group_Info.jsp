...
<form action="http://192.168.1.249:8001/interaction-service-2.0.0/playTimes" method="get">
 ...
 -->
<form action="<%=basePath%>/cczc/syncStubGroupInfo.do" method="get">
...
<td><input id="token" name="token" type="text" value="t" /></td>
</tr>
...
function init2(){
	...
	alert(document.body.appendChild(document.createElement('pre')).innerHTML);
}
