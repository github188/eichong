...
<form action="http://192.168.1.249:8001/interaction-service-2.0.0/playTimes" method="get">
 ...
 -->
<form action="<%=basePath%>/eichong/syncStubInfo.do" method="get">
...
<tr>
<td>stubGroupId<font color="red">*</font></td>
<td><input id="stubGroupId" name="stubGroupId" type="text" value="252" /></td>
</tr>
