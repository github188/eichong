    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.success == true) {
                ...
                voltageValue = parseFloat(data.voltageValue).toFixed(2);
                currentValue = parseFloat(data.currentValue).toFixed(2);
                presentChargeValue = parseFloat(data.presentChargeValue).toFixed(2);
                powerRateValue = parseFloat(parseFloat(voltageValue) * parseFloat(currentValue)/1000).toFixed(2);
