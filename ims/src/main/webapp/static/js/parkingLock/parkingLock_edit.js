...
function getDetailById(parkingLockId) {
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#lock_powerStationName').val(powerStationName);
            ...
            $('#ps_provinceCode').val(provinceCode);
            $('#ps_cityCode').val(cityCode);
            $('#ps_areaCode').val(areaCode);
            ...
            //去加载城市的省
            toLoadProvince(provinceCode, '#provinceCodeHtml', '.provinceUl', 'toUnbindEvent');
            toLoadCity(provinceCode, cityCode, '#cityCodeHtml', '.cityUl', 'toUnbindEvent');
...
function saveParkingLock() {
    if (testCity() && testAddressAndKey()) {
        ...
        $.ajax({
            type: "post",
            url: basePath + modifyParkingLockUrl,
            async: true,
            data: obj,
            success: function (data) {
