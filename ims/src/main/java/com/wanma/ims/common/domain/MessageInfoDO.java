...
public class MessageInfoDO extends BasicModel {

	/**
	 * 首页消息 
	 */
	private static final long serialVersionUID = -7426043459501176186L;
	...
	private java.lang.String messageInfoBegintime;//开始时间
	private java.lang.String messageInfoEndtime;//结束时间
	...
	private List<Map<String, Object>> powerstationList;
	...
	public java.lang.String getMessageInfoBegintime() {
		return messageInfoBegintime;
	}
	public void setMessageInfoBegintime(java.lang.String messageInfoBegintime) {
		this.messageInfoBegintime = messageInfoBegintime;
	}
	public java.lang.String getMessageInfoEndtime() {
		return messageInfoEndtime;
	}
	public void setMessageInfoEndtime(java.lang.String messageInfoEndtime) {
	...
	public List<Map<String, Object>> getPowerstationList() {
		return powerstationList;
	}
	public void setPowerstationList(List<Map<String, Object>> powerstationList) {
		this.powerstationList = powerstationList;
	}
	@Override
	public String toString() {
		return "MessageInfoDO [pkMessageInfoId=" + pkMessageInfoId
				...
				+ ", pkPowerstation=" + pkPowerstation + ", mprName=" + mprName
				+ ", messageInfoRegion=" + messageInfoRegion
				...
				+ messageInfoEndtimeStartTime + ", messageInfoEndtimeEndTime="
