...
public interface FinAccountService {
	...
	* @date 2017-6-20
	 */
	public Double getFinAccountBalance4User(AccountBalanceBO accountBalance) throws Exception;
	...
	* @date 2017-6-21
	...
	/**
	* <p>Description: 修改资金账户密码(重置为123456)</p>
	* @param
	* @author bingo
	* @date 2017-6-22
	 */
	...
	* @date 2017-11-30
	 */
	public int updateFinAccountPwd(Long accountId,String accountPwd, UserDO user) throws Exception;
