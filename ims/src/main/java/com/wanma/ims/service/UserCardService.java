...
public interface UserCardService {
	...
	* @author mb
	...
	BaseResultDTO bindCard(UserCardDO userCard, UserDO userDO);
	...
	* @author mb
	 ...
	 * @return
	 */
	BaseResultDTO bindCompanyForCard(String ids, CompanyDO company, UserDO loginUser, Integer tradeType, Long levelId);
