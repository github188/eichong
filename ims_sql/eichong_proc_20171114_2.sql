...
drop function IF EXISTS getCodeDetailName;
drop function IF EXISTS getDistance;
drop function IF EXISTS getFullPath;
drop function IF EXISTS getPathForServer; 
drop procedure IF EXISTS insert_coupon_proc;
drop procedure IF EXISTS role_menu_func;
drop procedure IF EXISTS proc_charging_record_accountId;
drop procedure IF EXISTS proc_purchase_history_accountId;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `t_afterdelete_on_p_m_menu_role` AFTER DELETE ON `p_m_menu_role` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `tri_powerstation_update` AFTER UPDATE ON `tbl_powerstation` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `getCodeDetailName`( codeGroupId VARCHAR(255), codeId VARCHAR(255)) RETURNS varchar(255) CHARSET utf8
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `getDistance`(  LngBeginP VARCHAR(100) , LngEnd REAL ,LatBeginP VARCHAR(100) , LatEnd REAL ) RETURNS double
BEGIN  
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `getFullPath`(fileType VARCHAR(255), referenceId VARCHAR(255)) RETURNS varchar(1024) CHARSET utf8
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `getPathForServer`( fileType VARCHAR(255), referenceId VARCHAR(255)) RETURNS varchar(1024) CHARSET utf8
BEGIN
  DECLARE deployUrl VARCHAR(255);
  DECLARE parentPath VARCHAR(255);
  DECLARE relativePath VARCHAR(255);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 FUNCTION `GET_FIRST_PINYIN_CHAR`(PARAM VARCHAR(255)) RETURNS varchar(2) CHARSET utf8
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 PROCEDURE `insert_coupon_proc`(cpUserid int, pkActivity int)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 */ /*!50003 PROCEDURE `role_menu_func`(
	roleId VARCHAR (30),
