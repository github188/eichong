...
function deleteFile(imageUrl,obj,referenceId){
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#buttonFileId_add").val("");
		$("#buttonFileId_add").val($("#buttonFileId_add").val()+dataId);
		var url=obj.navTabId;
	
		$("#addbtImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#addbtImage t").length;
	    if(fileSize>=1){ 
