...
function deleteFile(imageUrl,obj,referenceId){
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#bannerFileId_add").val("");
		$("#bannerFileId_add").val($("#bannerFileId_add").val()+dataId);
		var url=obj.navTabId;
		$("#addbaImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#addbaImage t").length;
	    if(fileSize>=1){ 
