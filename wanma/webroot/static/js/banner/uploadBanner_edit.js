...
function deleteFile(imageUrl,obj,referenceId){
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#bannerFileId_edit").val("");
		$("#bannerFileId_edit").val($("#bannerFileId_edit").val()+dataId);
		var url=obj.navTabId;
		$("#editbaImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#editbaImage t").length;
	    if(fileSize>=1){ 
