...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="configContent/findContentList.do?cocoConfigparameterid=${configcontent.cocoConfigparameterid}"
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><bmtag:link href="configContent/newContent.do?cocoConfigparameterid=${configcontent.cocoConfigparameterid}"  actionId="ACT-009-002"
				target="navTab" rel="newContent" messageKey="添加" dwzClass="add"/></li>
			...
			<li><bmtag:link href="configContent/deleteById.do?pageNum=${pager.pageNum }&pkConfigcontent={id}"
