...
<body>
	<div class="mainContent" style="width: 102%; background: #333"
		...
		<input id="headIdDiv" type="hidden" value="${params.headId}" /> <input
			...
			id="eChargeType" value="${params.eType}" /> <input id="pkHeadIdDiv"
			type="hidden" value="${params.pkHeadId}" /> <input type="hidden"
			id="titleName" value="${params.titleName}" />
			...
			<div style="width: 1000px; float: left; margin-top: 40px;">
				...
				<div class="tongji_biaoge">
					<ul>
						...
						<li class="tongji_biaoge_M"><span class="w140">充电次数<u>（次）</u></span>
							<span class="w160">${map_04.chCount01}</span> <span class="w140">${map_03.chCount01}</span>
							<span class="w140">${map_02.chCount01}</span> <span class="w220">${map_01.chCount01}</span></li>
						<li class="tongji_biaoge_M"><span class="w140">充电金额<u>（元）</u></span>
							<span class="w160">${map_04.chMoney01}</span> <span class="w140">${map_03.chMoney01}</span>
							<span class="w140">${map_02.chMoney01}</span> <span class="w220">${map_01.chMoney01}</span></li>
						<!--  
						...
						-->
						<li class="tongji_biaoge_M"><span class="w140">充电度数<u>（度）</u></span>
							<span class="w160">${map_04.chQuantity01}</span> <span
							class="w140">${map_03.chQuantity01}</span> <span class="w140">${map_02.chQuantity01}</span>
