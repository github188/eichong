...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="powerstation/getExaminePowersList.do"
...
<div class="pageContent">
	...
	<c:if test="${loginUserLevel == '1' || loginUserLevel == '2'}">
		<ul class="toolBar">
		 	<li>
				<bmtag:link isAuth="true"  target="selectedTodo" href="powerstation/changePowersState.do?changeType=examineOkPage"
				 	rel="ids" postType="string" altKey="确定通过吗？" dwzClass="edit" messageKey="通过" />	           
			</li>
			<li>
				<bmtag:link isAuth="true"  authUrl="powerstation/examineReasonUi.do"
...
function checkSelect(obj){
	...
	if (ids.length==0) {
		...
		navTab.openTab("", basepath+"/admin/powerstation/examineReasonUi.do", { title:"驳回", fresh:false, data:{id:ids.join()}});
	}
