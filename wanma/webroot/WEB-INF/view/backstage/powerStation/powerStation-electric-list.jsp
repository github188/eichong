...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="powerstation/getPowersElectricPileList.do"
			...
			<c:forEach items="${electricList}" var="electric" varStatus="status">
				<tr target="id" rel="${electric.pk_ElectricPile}" align="center">
				    <td><input type="checkbox" name="orgId"  
				   	 	value="{pkElectricpile:'${electric.pk_ElectricPile}',
				   	elpiElectricPileCode:'${electric.elPi_ElectricPileCode}',
				   	elpiElectricpilename:'${electric.elPi_ElectricPileName}',
				   	elpiState:'专属',
				   	chargingModeName:'${electric.chargingModeName}',
				   	powerName:'${electric.powerName}',
				   	typeName:'${electric.typeName}',
				   	powerSizeName:'${electric.powerSizeName}',
				   	rateInformationId:'${electric.elPi_RateInformationId}'	    	
				    	}" >
				    </td>
