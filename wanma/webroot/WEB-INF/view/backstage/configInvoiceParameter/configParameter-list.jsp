...
<div class="pageHeader">
	<form id="pagerForm" method="post" action="invoiceParameter/findConParaList.do?copaType=${configparameter.copaType}"
		...
		<tbody>
			<c:forEach items="${confparaList}" var="confpara" varStatus="status">
				<tr target="id" rel="${confpara.pkConfigparameter }" align="center">
					...
					<td>
						<a target="navTab" rel="findContentList" href="<c:url value='/admin/invoiceConfigContent/findContentList.do?cocoConfigparameterid=${confpara.pkConfigparameter}'/>" title="子项管理" style='color:#0099FF'>子项管理</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
