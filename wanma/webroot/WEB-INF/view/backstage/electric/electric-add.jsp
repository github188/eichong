		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				...
				<dd>
					<input name="elpiLongitude" id="longitude"
						class="textInput required" maxlength="11" max="136" min="74"
			...
			<dl>
				...
				<dd>
					<input name="elpiLatitude" class="textInput required"
						maxlength="11" style="width: 165px;" max="54" min="18" /> <span
						class="info"></span>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<select name="elpiChargingmode" class="select_Style"
						onchange="changePileNum(this.value)">
			...
			<c:if test="${loginUserLevel != 5}">
				<dl>
					...
					<dd>
						<input name="companyNumber" type="hidden" value="0"
							id="companyNumber" /> <input name="companyName" type="text"
			...
			<dl>
				...
				<dd>
					<input name="ownerShip" class="textInput required" maxlength="20"
						style="width: 165px;" /> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<select name="elPiOwnProvinceCode" style="width: 172px !important"
						class="select_Style" onchange="getCity(this)">
						<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd>
					<select id="cityId" name="elPiOwnCityCode"
						class="select_Style addCityId" onchange="getCounty(this)">
						<option value="">-请选择-</option>
					</select> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<select id="countyId" name="elPiOwnCountyCode"
						class="select_Style addCountyId" onchange="getRateinfo(this)">
						<option value="">-请选择-</option>
					</select> <span class="info"></span>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd id="imageDD">
					<input type="hidden" id="businessType" name="businessType"
						...
						name="fileId" /> <input id="electricAddFileInput" type="file"
			...
			<dl>
				...
				<dd>
					<input name="elPi_Tell" value="4000850006" class="textInput"
						maxlength="50" style="width: 165px;" /> <span class="info"></span>
				</dd>
			</dl>
			<dl>
			...
			<dl>
				...
				<dd>
					<select class="required" id="elPiRateInformationId"
						name="elPiRateInformationId" class="select_Style">
						<option value="">-请选择-</option>
					</select> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<input name="elPiSimPhoneNum" class=" textInput " maxlength="13"
						style="width: 165px;" /> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<input name="elPiSimMac" class="textInput " maxlength="20"
						style="width: 165px;" /> <span class="info"></span>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<input id="new_offlineTime" class="date" dateFmt="yyyy-MM-dd HH:mm"
						type="text" readonly="true" name="offlineTime"
						style="width: 130px"
						onClick="WdatePicker({el:'new_offlineTime',dateFmt:'yyyy-MM-dd HH:mm',minDate:'1970-01-01'})" />
					<span class="info"></span>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<input id="elpiPowernumber" name=elpiPowernumber
						class="textInput required" maxlength="20" style="width: 165px;"
						max="4" value="1" readonly /> <span class="info"></span>
				</dd>
			</dl>
					...
					<table>
						...
						<thead>
							<tr height="30">
								...
								<th align="left">地锁</th>
								<th align="left">雷达</th>
								<th align="left"><div class="button">
										<div class="buttonContent" style="width: 30px">
						...
						<tbody id="row_head">
							<tr>
								<td><input class="required" name="headList[0].ephNum"
									type="text"></td>
								<td><select style="width: 80px" class="required"
									name="headList[0].havaCarPlaceLock">
										<option value="0">无</option>
										<option value="1">有</option>
								</select></td>
								<td><select style="width: 80px" class="required"
									name="headList[0].haveRadar">
										<option value="0">无</option>
										<option value="1">有</option>
								</select></td>
								<td><div class="button">
										<div class="buttonContent" style="width: 30px">
											<button type="button" onclick="removeTr(this)">删除</button>
										</div>
									</div></td>
							</tr>
						</tbody>
