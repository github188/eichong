...
<h2 class="contentTitle">
	<bmtag:message messageKey="electriclabel.showUser" />
</h2>
	...
	<form method="post" action="electric/changeElectricPile.do"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elpiElectricpilecode}" />
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elpiElectricpilename}" />
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<select name="elpiChargingmode" class="select_Style"
						disabled="disabled">
						<c:forEach var="item" items="${chargeList}">
							<option value="${item.pkConfigcontent}"
								${item.pkConfigcontent == tblElectricpile.elpiChargingmode ? 'selected="selected"' : ''}>
			...
			<dl>
				...
				<dd>
					<select name="elpiState" class="select_Style" disabled="disabled">
						<option value="0"
							${tblElectricpile.elpiState==0 ? 'selected="selected"' : ''}>草稿</option>
						<option value="5"
							${tblElectricpile.elpiState==5 ? 'selected="selected"' : ''}>提交审核</option>
						<option value="12"
							${tblElectricpile.elpiState==12 ? 'selected="selected"' : ''}>分享申请中</option>
						<option value="3"
							${tblElectricpile.elpiState==3 ? 'selected="selected"' : ''}>已驳回</option>
						<option value="10"
							${tblElectricpile.elpiState==10 ? 'selected="selected"' : ''}>专属</option>
						<option value="15"
							${tblElectricpile.elpiState==15 ? 'selected="selected"' : ''}>分享</option>
					</select> <span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					<select name="elpiPowersize" class="select_Style"
						...
						<c:forEach var="item" items="${powerList}">
							<option value="${item.pkConfigcontent}"
								${item.pkConfigcontent == tblElectricpile.elpiPowersize ? 'selected="selected"' : ''}>
								${item.cocoContent}</option>
			...
			<dl>
				...
				<dd>
					<bmtag:message
						messageKey="${tblElectricpile.elpiElectricpileaddress}" />
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elpiRemark}" />
				...
				<dd>
					<select name="elpiType" class="select_Style" disabled="disabled">
						<c:forEach var="item" items="${typeList}">
							<option value="${item.pkConfigcontent}"
								${item.pkConfigcontent == tblElectricpile.elpiType ? 'selected="selected"' : ''}>
								${item.cocoContent}</option>
			...
			<dl>
				...
				<dd>
					<select name="elpiTypeSpanId" id="elpiTypeSpanId"
						class="select_Style required" disabled="disabled">
			...
			<c:if test="${loginUserLevel != 5}">
				<dl>
					...
					<dd>${tblElectricpile.companyName}</dd>
				</dl>
			</c:if>
			...
			<dl>
				...
				<dd>
					<select name="elPiOwnerCompany" class="select_Style"
						disabled="disabled">
			...
			<dl>
				...
				<dd>
					<select name="elPiOwnProvince" disabled="disabled"
			...
			<dl>
				...
				<dd>
					<select id="cityId" disabled="disabled" name="elPiOwnCity"
						class="select_Style">
						<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd>
					<select id="countyId" disabled="disabled" name="elPiOwnCounty"
						class="select_Style">
						<option value="">-请选择-</option>
			...
			<dl>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elPi_Tell}" />
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elPiOnlineTime}" />
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					<bmtag:message messageKey="${tblElectricpile.raIn_ReservationRate}" />
				</dd>
			</dl>
			<dl>
				<dt>
			...
			<dl>
				...
				<dd>
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elpiOutputvoltage}" />
					<span class="info"></span>
				</dd>
			</dl>
			<dl>
				...
				<dd>
				<dd>
					<bmtag:message messageKey="${tblElectricpile.elpiOutputcurrent}" />
					<span class="info"></span>
				</dd>
			</dl>
			...
			<dl>
				...
				<dd>
					<select class="required" id="gateId" disabled="disabled"
						name="gateId" class="select_Style">
						<option value="">无</option>
						<c:forEach var="item" items="${gateList}">
							<option value="${item.pkGateid}"
								${item.pkGateid==
			...
			<dl>
				...
				<dd>
					...
					<input maxlength="20" class="textInput" readonly
						style="width: 165px;" value="${tblElectricpile.elpiPowernumber}" />
				</dd>
			</dl>
					...
					<table width="30%">
						...
						<tbody id="row_head">
							<c:forEach var="headInfo" items="${tblElectricpile.headList}"
								varStatus="status">
								<tr>
									<td><input type="text" readonly value="${headInfo.ephNum}"></td>
