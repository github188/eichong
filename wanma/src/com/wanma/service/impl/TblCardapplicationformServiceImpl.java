...
public class TblCardapplicationformServiceImpl implements
	...
	@Override
	public void updateCardReject(String pkCardAppFromId) {
		 cardapplicationformMapper.updateCardReject(pkCardAppFromId);
	}

	@Override
	public void updateApplyCard(String pkCardAppFromId) {
		cardapplicationformMapper.updateApplyCard(pkCardAppFromId);
	}
