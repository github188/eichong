...
@Service
public class CmsMapStatisticsServiceImpl extends CmsEchartsV2ServiceImpl {
	@Autowired
	CmsEchartsStatisticMapper statisticsMapper;

	@Override
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void setData(JSONObject obj, Map<String, Object> params) {
		...
		if (pileProviceCountlist != null && !pileProviceCountlist.isEmpty()) {
			...
			for (Map<Object, Object> tempObj : pileProviceCountlist) {
				...
				if(8231==userId&&count!=""){
					count = String.valueOf(Integer.parseInt(count)*5);
				}
				provinceMap = new HashMap();
				provinceMap.put("name", province);
				provinceMap.put("value", count);
				provinceMap.put("id", tempObj.get("province_id"));
				provinceMap.put("elPi_Latitude", tempObj.get("elPi_Latitude"));
				provinceMap.put("elPi_Longitude", tempObj.get("elPi_Longitude"));
...
//				setData2(provinceGroup, pileProviceTypeCountlist, obj);
...
//			}
	...
	private void setData2(List<String> provinceGroup,
			List<Map<Object, Object>> pileProviceTypeCountlist, JSONObject obj) {
