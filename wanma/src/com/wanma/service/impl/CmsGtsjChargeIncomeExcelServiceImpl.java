...
@Service
public class CmsGtsjChargeIncomeExcelServiceImpl extends CmsExcelServiceImpl {
	@Autowired
	private CmsExcelReportMapper excelReportMapper;
	private String[] columns = { "个体商家名称","月份","次数", "总电量(度数)","总收益金额(元)" };//初始化列名
	...
	protected void makeExcelData(SXSSFWorkbook wb, Object paramsModel) {
		...
		List<Map<String, Object>> list = excelReportMapper
				.queryGtsjChargeIncomeList((ExcelParamModel)paramsModel);
