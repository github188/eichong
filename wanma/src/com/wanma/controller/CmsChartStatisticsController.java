...
public class CmsChartStatisticsController {
	@Autowired
	...
	public String getChargeInfoCount(@RequestParam Map<String, Object> params,HttpServletRequest request) throws URISyntaxException {
		...
		data.put("data1",cmsAssetStatisticsServiceImpl.queryChargeInfoCount(params));
		data.put("userId",loginUser.getUserId());
		return JSONObject.toJSONString(data);
	}
	...
	public String getHeadInfoCount(@RequestParam Map<String, Object> params,HttpServletRequest request) throws URISyntaxException {
		...
		params.put("userId", loginUser.getUserId());
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("data1",cmsAssetStatisticsServiceImpl.queryHeadInfoCount(params));
		data.put("userId",loginUser.getUserId());
		return JSONObject.toJSONString(data);
	}
	 ...
	 * @throws URISyntaxException
	 */
	@RequestMapping("/getCarLicenseValue")
	@ResponseBody
	public String getCarLicenseValue(@RequestParam Map<String, Object> params,HttpServletRequest request) throws URISyntaxException {
		return JSONObject.toJSONString(cmsAssetStatisticsServiceImpl.getCarLicenseValue(params));
	}
