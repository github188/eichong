...
public class TblFeedback extends BasicListAndMutiFile implements Serializable {
	...
	private java.lang.Integer febaUserid; // 用户ID tbl_User_normal_view中获取
	...
	/**
     * 获取用户ID tbl_user_normal_view中获取属性
     *
     * @return febaUserid
     */
	...
	/**
	 * 设置用户ID tbl_user_normal_view中获取属性
	 *
	 * @param febaUserid
	 */
    ...
    public String toString() {
        ...
        sb.append("TblFeedback");
        sb.append("{pkFeedback=").append(pkFeedback);
        sb.append(", febaContent=").append(febaContent);
        sb.append(", febaUserid=").append(febaUserid);
        sb.append(", febaCreatedate=").append(febaCreatedate);
        sb.append(", febaUpdatedate=").append(febaUpdatedate);
		sb.append('}');
        return sb.toString();
    }
}