...
public class TblSocCharge extends BasicListAndMutiFile  implements Serializable {
	...
	private java.lang.Integer  argId;//参数ID（1：定soc开关设置；）
	private java.lang.Integer  argValue;//参数值（0：关；1：开；）
	private java.lang.Integer  status;//状态
	private java.lang.Integer  issuedStatus;//下发给电桩状态（0：未下发定Soc；1：下发定Soc成功；2：下发定Soc失败；）
	private String  deleteFlag;//删除标志（0：否：1：是；）
	private String operator;//操作人（创建人或修改人）
	...
	public java.lang.Integer getArgId() {
		return argId;
	}
	public void setArgId(java.lang.Integer argId) {
		this.argId = argId;
	}
	public java.lang.Integer getArgValue() {
		return argValue;
	}
	public void setArgValue(java.lang.Integer argValue) {
	...
	public String toString() {
		return "TblSocCharge [pkElectricpile=" + pkElectricpile
				+ ", elpiElectricpilename=" + elpiElectricpilename
				+ ", postName=" + postName + ", elPiMakerName=" + elPiMakerName
				...
				+ ", elPiOwnCountyCode=" + elPiOwnCountyCode
				+ ", elpiElectricpilecode=" + elpiElectricpilecode + ", argId="
				+ argId + ", argValue=" + argValue + ", status=" + status
				+ ", issuedStatus=" + issuedStatus + ", deleteFlag="
				+ deleteFlag + ", operator=" + operator + ", elpiUserid="
				+ elpiUserid + ", userLevel=" + userLevel + "]";
	}
