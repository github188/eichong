...
<form method="post" action="applyPartner/updatePersonApplyReason.do" class="pageForm required-validate" 
 ...
 <input type="hidden" name="pkApplyPartner" value="${tblApplyPartner.pkApplyPartner}" />
  <input type="hidden" name="navTabId" value="applyPersonPartner" />
