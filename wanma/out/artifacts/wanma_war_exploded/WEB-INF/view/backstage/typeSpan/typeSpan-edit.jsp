							...
							<c:forEach items="${bomList}" var="bom" varStatus="status">
								<tr class="bomList">
									<td>
										...
										<input class="required rmIndex" name=".blHardwareNumber" type="text" value="${bom.blHardwareNumber}">
									</td>
									<td><input class="required rmIndex" name=".blHardwareVersion" type="text" value="${bom.blHardwareVersion}"></td>
									<td><input class="required rmIndex" name=".blFirmwareNumber" type="text" value="${bom.blFirmwareNumber}"></td>
									<td><input class="required rmIndex" name=".blFirmwareVersion" type="text" value="${bom.blFirmwareVersion}"></td>
									<td><input class="required rmIndex" name=".blFileMd5" type="text" minlength="32" maxlength="32" style="width:230px;" value="${bom.blFileMd5} "></td>
									<td><div style="width: 80px;margin-left: 10px;">
										<input class="required rmIndex" name="${status.index}.blForceUpdate" value="1" type="radio" <c:if test="${bom.blForceUpdate == '1'}">checked</c:if>>是
										<input class="required rmIndex" name="${status.index}.blForceUpdate" value="0" type="radio" <c:if test="${bom.blForceUpdate == '0'}">checked</c:if>>否
										</div>
									</td>
									<td></td>
								</tr>
