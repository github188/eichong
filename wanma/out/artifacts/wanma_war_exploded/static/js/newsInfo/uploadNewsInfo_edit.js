...
function deleteFile(imageUrl,obj,referenceId){
		...
		var businessType=$("#businessType_edit").val();
		$.ajax({
			type : 'post',
	...
	function FileUploadSuccess(file, data, response){
		...
		$("#newsInfoFileId_edit").val("");
		$("#newsInfoFileId_edit").val($("#newsInfoFileId_edit").val()+dataId);
		var url=obj.navTabId;
		$("#editniImage").prepend('<t><img  src="'+url+'" style="width: 150px; height: 150px;" />'
	...
	function FileUploadStart(file) {
		errorFlag=true;
	    var fileSize=$("#editniImage t").length;
	    if(fileSize>=1){ 
