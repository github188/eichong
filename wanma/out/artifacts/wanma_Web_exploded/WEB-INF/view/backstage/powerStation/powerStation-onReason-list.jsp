...
<div class="pageHeader">
	<form method="post" action="powerstation/onReason.do" id="addForm"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, navTabAjaxDone);">
		<input type="hidden" name="ids" value="${pkPowerstation}" />
		<dt>
		 <dl> <textarea name="rejectionReason" rows="13" cols="85" id="textarea"
