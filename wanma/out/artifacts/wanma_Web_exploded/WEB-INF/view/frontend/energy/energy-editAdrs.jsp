        ...
        <div class="cm-con-bm clearfix">
            ...
            <div class="content-right">
                <div class="login-detail">
                		<input name="pkUseraddress" value="${useraddress.pkUseraddress}" type="hidden"/>
                    <div class="mt10 clearfix">
                        <p class="fl tm title">联系人姓名</p>
                        <p class="wrap fl">
                            <input name="pradUsername" value="${useraddress.pradUsername}" data-rule="联系人姓名:required" placeholder="输入您的真实姓名">
                    ...
                    <div class="mt10 clearfix">
                        ...
                        <p class="wrap fl">
                            <input name="pradPhonenumber" value="${useraddress.pradPhonenumber}" data-rule="手机号码或者用户名:required;mobile" placeholder="11位手机号码">
                    ...
                    <div class="mt10 clearfix">
                        ...
                        <p class="wrap fl">
                            <input name="pradPostalCode" value="${useraddress.pradPostalCode}" data-rule="邮政编码:required;postcode" placeholder="6位邮编">
                    ...
                    <div class="mt10 clearfix">
                        ...
                        <p class="wrap fl">
                            <input name="pradAddress" value="${useraddress.pradAddress}" data-rule="省、市、区:required" placeholder="请输入">
                    ...
                    <div class="mt10 clearfix">
                        ...
                        <p class="wrap fl">
                            <input name="pradStreet" value="${useraddress.pradStreet}" data-rule="街道:required" placeholder="请输入">
...
<script src="<%=request.getContextPath()%>/static/js/energy/editAdrs.js" type="text/javascript"></script>
</body>
</html>