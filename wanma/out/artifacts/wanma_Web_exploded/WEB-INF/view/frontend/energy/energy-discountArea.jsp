...
<div class="content">
    ...
    <div class="search-electric newGoods">
            ...
            <ul class="electric-con">
                <li>
                    <a href="electric_info.html">
                        <img src="<%=request.getContextPath()%>/static/images/img/car_icon.png"/>
                    </a>
                    ...
                    <p class="mt5 fc-orange price">
                        <span class="fl fc-orange f16">&yen;<span class="num ml10">800元</span><del class="fc-gray">&yen;<span
                                class="ml30 fc-gray">900元</span></del></span>
        ...
        <div class="map-con toggle none">
            <img src="<%=request.getContextPath()%>/static/images/img/searchmap_icon.png">
        </div>
        <div class="page">
