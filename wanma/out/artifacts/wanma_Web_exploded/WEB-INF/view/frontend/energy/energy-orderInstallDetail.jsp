...
<div class="content">
	...
	<div class="address-wrap mt20" id="detail-data">
		...
		<div class="all mt10">
			...
			<div class="fr all-r">
				<button class="all-btn" id="orderSubmit">提交</button>
...
<script type="text/html" id="detail-data-tmpl">
	<p class="tx">
				收货人：
				<span id="receive_people"><!--[=pradUsername]--></span>
				<span id="receive_phone"><!--[=pradPhonenumber]--></span>
			</p>
			<p class="tx mt5">
				收货地址：
				<span id="receive_address"><!--[=pradAddress]--></span>
			</p>
			
			<a class="arrow" href="address.do?a=<!--[=orderId]-->&ty="installOrder""></a>
</script>
...
<script type="text/html" id="data-list-tmpl">
	...
	<div class="god-moudel">
		...
		<script src="<%=request.getContextPath()%>/static/js/energy/rorderInstallDetail.js" type="text/javascript"></script>
