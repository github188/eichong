...
.img405 {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url(../static/images/error.jpeg) no-repeat left top; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 100%; PADDING-TOP: 0px; POSITION: relative; HEIGHT: 100%}
.content {	CLEAR: both; PADDING-RIGHT: 0px; PADDING-LEFT: 0px; FONT-SIZE: 13px; LEFT: 80px; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 80%; LINE-HEIGHT: 19px; PADDING-TOP: 0px; POSITION: relative; }
.content UL {list-style:none;PADDING-RIGHT: 35px; PADDING-LEFT: 35px; PADDING-BOTTOM: 20px; MARGIN: 0px; PADDING-TOP: 10px}
...
<DIV class=img404>　
<H2 >抱歉，找不到您要的页面……</H2>
<H3 >We're sorry but the page your are looking for is Not 
Found...</H3>
<H4 >仔细找过啦，没有发现你要找的页面。最可能的原因是： </H4>
<DIV class=content>
  <UL>
  <LI>在地址中可能存在键入错误。 </LI>
  <LI>当你点击某个链接时，它可能已过期。 
