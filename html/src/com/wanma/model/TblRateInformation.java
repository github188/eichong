...
public class TblRateInformation {
	private java.lang.Long pkRateInformation; 				// 主键
	...
	private java.lang.String raInQuantumDate; 				// 采用JSON形式存储的费率
	...
	private java.math.BigDecimal raInReservationRate; 		// 预约单价
	private java.math.BigDecimal raInServiceCharge; 		// 服务费
	private java.math.BigDecimal raInWarnMoney; 			// 告警余额
	private java.lang.Long elcId; 							// 电桩主键
	private java.lang.Long psId; 							// 电站主键
	private java.math.BigDecimal raInTipTimeTariffMoney;//尖时段服务费
	private java.math.BigDecimal raInPeakElectricityMoney;//峰时间服务费
	private java.math.BigDecimal raInUsualMoney;//平时段服务费
	private java.math.BigDecimal raInValleyTimeMoney;//谷时段服务费
	private Integer raInType;//费率类型 (1:两位,2:四位,3:新账户费率)
	
	
	
//	private java.lang.String userId;		// 添加费率的用户，p_m_user表的id
//	private java.lang.String raInAreaId;	// 区县编号
//	private java.lang.String raInCityId;	// 市级编号
//	private java.lang.String raInProviceId;	// 省级编号
    ...
    public java.lang.Long getPkRateInformation() {
		return pkRateInformation;
	}

	public java.math.BigDecimal getRaInTipTimeTariffMoney() {
		return raInTipTimeTariffMoney;
	}

	public void setRaInTipTimeTariffMoney(
			java.math.BigDecimal raInTipTimeTariffMoney) {
		this.raInTipTimeTariffMoney = raInTipTimeTariffMoney;
	}

	public java.math.BigDecimal getRaInPeakElectricityMoney() {
		return raInPeakElectricityMoney;
	}

	public void setRaInPeakElectricityMoney(
			java.math.BigDecimal raInPeakElectricityMoney) {
		this.raInPeakElectricityMoney = raInPeakElectricityMoney;
	}

	public java.math.BigDecimal getRaInUsualMoney() {
		return raInUsualMoney;
	}

	public void setRaInUsualMoney(java.math.BigDecimal raInUsualMoney) {
		this.raInUsualMoney = raInUsualMoney;
	}

	public java.math.BigDecimal getRaInValleyTimeMoney() {
		return raInValleyTimeMoney;
	}

	public void setRaInValleyTimeMoney(java.math.BigDecimal raInValleyTimeMoney) {
		this.raInValleyTimeMoney = raInValleyTimeMoney;
	}

	public void setPkRateInformation(java.lang.Long pkRateInformation) {
	...
	public void setRaInMinFreezingMoney(java.math.BigDecimal raInMinFreezingMoney) {
	...
	public java.lang.Long getElcId() {
		return elcId;
	}

	public void setElcId(java.lang.Long elcId) {
		this.elcId = elcId;
	}
    ...
    public String toString() {
        return "TblRateInformation{" +
                "pkRateInformation=" + pkRateInformation +
                ", raInModelId=" + raInModelId +
                ", raInEffectiveDates=" + raInEffectiveDates +
                ", raInExpiryDate=" + raInExpiryDate +
                ", raInFreezingMoney=" + raInFreezingMoney +
                ", raInMinFreezingMoney=" + raInMinFreezingMoney +
                ", raInQuantumDate='" + raInQuantumDate + '\'' +
                ", raInStartQuantumDate=" + raInStartQuantumDate +
                ", raInEndQuantumDate=" + raInEndQuantumDate +
                ", raInTimeMarker=" + raInTimeMarker +
                ", raInTipTimeTariff=" + raInTipTimeTariff +
                ", raInPeakElectricityPrice=" + raInPeakElectricityPrice +
                ", raInUsualPrice=" + raInUsualPrice +
                ", raInValleyTimePrice=" + raInValleyTimePrice +
                ", raInReservationRate=" + raInReservationRate +
                ", raInServiceCharge=" + raInServiceCharge +
                ", raInWarnMoney=" + raInWarnMoney +
                ", elcId=" + elcId +
                ", psId=" + psId +
                ", raInTipTimeTariffMoney=" + raInTipTimeTariffMoney +
                ", raInPeakElectricityMoney=" + raInPeakElectricityMoney +
                ", raInUsualMoney=" + raInUsualMoney +
                ", raInValleyTimeMoney=" + raInValleyTimeMoney +
                ", raInType=" + raInType +
                '}';
    }
}