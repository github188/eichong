...
//        }
    ...
    public static String doPost(String url, Map<String, String> params)  {
    	...
    	String response="";
    	try {
	    	if(StringUtils.isBlank(WanmaConstants.API_TOKEN)){
	    		token = ApiUtil.getToken();
	    		WanmaConstants.API_TOKEN=token;
	    	}
	    	params.put("t", WanmaConstants.API_TOKEN);
	    	response=HttpRequest.post(WanmaConstants.API_ROOT+url, params);
	    	JSONObject json=JSON.parseObject(response);
	    	if(((String)json.getString("status")).equals("5000")){
					token = ApiUtil.getToken();
					params.put("t", token);
					response=HttpRequest.post(WanmaConstants.API_ROOT+url, params);
	    	}
     ...
     * @throws Exception 
     */ 
    public static String doChargeGiftPost(String url, Map<String, String> params)  {
    	String token="";
    	String response="";
    	try {
	    	if(StringUtils.isBlank(WanmaConstants.API_TOKEN)){
    ...
    public static void main2(String[] args) { 
            ...
            String x = doPost("/app/net/sendTwoDiCode.do", map); 
