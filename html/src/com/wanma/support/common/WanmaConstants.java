...
public class WanmaConstants {
	...
	public static String PREFIX_ORG="app:org:";
	public static String PREFIX_TOKWEN="app:token:";
	public static String THIRD_TONKEN="third:token:";
	public static int PREFIX_TOKWEN_TERM=86400000;
	public static String SYNC_TIME="app:sync:time";
	public static String DEFAULT_DEVICE_ID="e10adc3949ba59abbe56e057f20f883e";
	/** 推送充电订单实时信息缓存目录*/
	public static String PREFIX_CHARGING_ORDER = "app:chor:";
	/**南瑞-充电订单推送缓存目录*/
	public static String NARI_ORDER_TIME = "third:order:time";
	/** 图片分类定义 */
	 ...
	 * 扫描二维码数字编码
	 */
	public static String API_URL_SELECT_NUM_PILEINFO="/app/electricPileDetail/zNumSelPileInfo.do";
	/**
	 * 我的钱包
	 */
	 ...
	 * 设置支付密码
	 */
	public static String setPayCipher="/app/user/setPayPwd.do";
	/**
	 * 检查支付密码有效性
	 */
	public static String checkPayCipher="/app/user/checkPayPwd.do";
	/**
	 * 修改支付密码
	 */
	public static String modPayCipher="/app/user/modPayPwd.do";
	/**
	 * 修改登陆密码
	 */
	public static String modCipher="/app/user/modPassword.do";
	/**
	 * 充电订单列表/详情
	 */
	 ...
	 * 立即充电（第三方）
	 */
	public static String API_URL_BEGIN_CHARGE_TPI="/app/chargeShow/beginChargeTpi.do";
	/**
	 * 结束充电
	 */
	 ...
	 * 结束充电（第三方）
	 */
	public static String API_URL_FINISH_CHARGE_TPI="/app/chargeShow/finishChargeTpi.do";
	/**
	 * 分享电桩
	 */
	 ...
	 * 	找回密码
	 */
	public static String resetCipher="/app/user/resetPasswrod.do";

	public static CommonServer cs = CommonServer.getInstance();
	
	public static ConcurrentMap<String,Object> startCgEvt = new ConcurrentHashMap<String,Object>();//开始充电数据缓存
	
	public static ConcurrentMap<String,Object> stopCgEvt = new ConcurrentHashMap<String,Object>();//结束充电数据缓存
	
	public static ConcurrentMap<String,Object> chargingOrderEvt = new ConcurrentHashMap<String,Object>();//结束充电数据缓存
	public static int DATA_LOOP_COUNT=100;
	public static int DATA_LOOP_SLEEP=100;
	public static final int CCZC_CODE=9002;
	public static final int ECW_CODE=1011;
	public static final int SHSZ_CODE=425010765;
	public static final int WX_CODE=9006;
}
